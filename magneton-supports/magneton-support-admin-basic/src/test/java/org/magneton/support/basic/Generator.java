...
class Generator {
	...
	@Tables(
			...
			srcDir = "/magneton-supports/magneton-support-basic/src/main/java",
			// 设置entity类的package值
			basePack = "org.magneton.support.basic",
			// 设置dao接口和实现的src目录, 相对于 user.dir
			daoDir = "/magneton-supports/magneton-support-basic/src/main/java",
			// 生成的数据实体的后缀
			entitySuffix = "DO",
			// 设置哪些表要生成Entity文件
			tables = { @Table(value = { "basic_sys_config" }) })
	static class Empty {
