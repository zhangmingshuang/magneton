...
class ObjectInjectorTest {
  ...
  private static void init() {
    config
        ...
        .setMinDouble(1D)
        .setMaxDouble(1D)
        .setBooleanTrueProbability(100)
        .setMinBigInteger(BigInteger.ONE)
        .setMaxBigInteger(BigInteger.ONE)
        .setMinBigDecimal(BigDecimal.ONE)
        .setMaxBigDecimal(BigDecimal.ONE);
  }
