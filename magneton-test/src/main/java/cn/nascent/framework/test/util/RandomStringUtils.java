 ...
 *
 * <p>
 * <b>Caveat: Instances of {@link Random}, upon which the implementation of this class
 * relies, are not cryptographically secure.</b>
 *
 * <p>
 * RandomStringUtils is intended for simple use cases. For more advanced use cases
 * consider using Apache Commons Text's <a href=
 ...
 *
 * <p>
 * The Apache Commons project provides <a href="https://commons.apache.org/rng">Commons
 * RNG</a> dedicated to pseudo-random number generation, that may be a better choice for
 * applications with more stringent requirements (performance and/or correctness).
 *
 * <p>
 * Note that <em>private high surrogate</em> characters are ignored. These are Unicode
...
public class RandomStringUtils {
	...
	public static String randomAscii(final int minLengthInclusive, final int maxLengthExclusive) {
		return randomAscii(ThreadLocalRandom.current().nextInt(minLengthInclusive, maxLengthExclusive));
	}
	...
	public static String randomAlphabetic(final int minLengthInclusive, final int maxLengthExclusive) {
		return randomAlphabetic(ThreadLocalRandom.current().nextInt(minLengthInclusive, maxLengthExclusive));
	}
	...
	public static String randomAlphanumeric(final int minLengthInclusive, final int maxLengthExclusive) {
		return randomAlphanumeric(ThreadLocalRandom.current().nextInt(minLengthInclusive, maxLengthExclusive));
	}
	 ...
	 * [:graph:] regular expression character class. This class contains all visible ASCII
	 * characters (i.e. anything except spaces and control characters).
	 * @param count the length of random string to create
	 * @return the random string
	 * @since 3.5
	 */
	...
	public static String randomGraph(final int minLengthInclusive, final int maxLengthExclusive) {
		return randomGraph(ThreadLocalRandom.current().nextInt(minLengthInclusive, maxLengthExclusive));
	}
	...
	public static String randomNumeric(final int minLengthInclusive, final int maxLengthExclusive) {
		return randomNumeric(ThreadLocalRandom.current().nextInt(minLengthInclusive, maxLengthExclusive));
	}
	 ...
	 * <p>
	 * Characters will be chosen from the set of characters which match the POSIX
	 * [:print:] regular expression character class. This class includes all visible ASCII
	...
	public static String randomPrint(final int minLengthInclusive, final int maxLengthExclusive) {
		return randomPrint(ThreadLocalRandom.current().nextInt(minLengthInclusive, maxLengthExclusive));
	}
	 ...
	 * {@link #random(int,int,int,boolean,boolean,char[],Random)}, but instead of using an
	 * externally supplied source of randomness, it uses the internal static
	 ...
	 * @param chars the set of chars to choose randoms from. If {@code null}, then it will
	 * use the set of all chars.
	 * @return the random string
	 * @throws ArrayIndexOutOfBoundsException if there are not {@code (end - start) + 1}
	 ...
	 * numbers are both {@code
	 * false}, in which case, start and end are set to {@code 0} and
	 ...
	 * @throws ArrayIndexOutOfBoundsException if there are not {@code (end - start) + 1}
	 * characters in the set array.
	 * @throws IllegalArgumentException if {@code count} &lt; 0 or the provided chars
	 * array is empty.
	 * @since 2.0
	 */
	 ...
	 *
	 * <p>
	 * Characters will be chosen from the set of characters specified by the string, must
	 * not be empty. If null, the set of all characters is used.
	 * @param count the length of random string to create
	 * @param chars the String containing the set of characters to use, may be null, but
	 * must not be empty
	 * @return the random string
