...
public class AnnotationUtils {
	...
	@Nullable
	public static <A extends Annotation> A findAnnotation(@Nullable Class clazz, Class<A> annotationClass) {
	...
	private static List<Annotation> findAnnotations(List<Annotation> annotations, @Nullable Class clazz) {
