 ...
 *
 * <p>如果两个对象的任意一个数据不相等，则返回 {@code false}
 *
...
public class ValueEqualsBooleanSupplier extends AbstractEqualsSupplier<ValueEqualsBooleanSupplier> {
  ...
  @Override
  protected boolean doFeieldValueNotEqualsProcess(
      Class<?> fieldClass, Object fieldValue1, Object fieldValue2) {
    if (Date.class.isAssignableFrom(fieldClass)
        || java.sql.Date.class.isAssignableFrom(fieldClass)) {
