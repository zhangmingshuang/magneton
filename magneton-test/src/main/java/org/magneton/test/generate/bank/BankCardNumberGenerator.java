package org.magneton.test.generate.bank;

import java.util.Random;
import java.util.concurrent.ThreadLocalRandom;
import org.magneton.test.generate.base.GenericGenerator;
import org.magneton.test.generate.util.LuhnUtils;
...
public class BankCardNumberGenerator extends GenericGenerator {
  ...
  public static String generate(BankNameEnum bankName, BankCardTypeEnum cardType) {
    ...
    Integer prefix =
        candidatePrefixes[ThreadLocalRandom.current().nextInt(candidatePrefixes.length)];
