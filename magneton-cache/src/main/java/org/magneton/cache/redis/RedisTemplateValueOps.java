...
public class RedisTemplateValueOps extends AbstractRedisTemplateOps implements ValueOps {
	...
	public RedisTemplateValueOps(RedisTemplate redisTemplate, RedisValueSerializer redisValueSerializer) {
	...
	public List<Boolean> set(List<KV> kvs) {
		return this.redisTemplate.executePipelined((RedisCallback<Boolean>) rc -> {
