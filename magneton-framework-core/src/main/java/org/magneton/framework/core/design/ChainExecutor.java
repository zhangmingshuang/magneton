...
import org.magneton.framework.core.design.chain.ChainContext;
...
public class ChainExecutor {
	...
	private static void doExecute(org.magneton.framework.core.design.chain.Chain chain, ChainContext chainContext,
			boolean clean) {
		List<org.magneton.framework.core.design.chain.Chain.Node> nodes = chain.getChainNodes();
