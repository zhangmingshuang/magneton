...
import org.magneton.framework.core.design.chain.Chain;
import org.magneton.framework.core.design.chain.ChainBus;
import org.magneton.framework.core.design.chain.ChainNode;
import org.magneton.framework.core.design.exception.DuplicateChainException;
import org.magneton.framework.core.design.exception.ExtNotFoundException;
import org.magneton.framework.core.ext.CopyOnWriteHashMap;
...
public class ChainRegistrar {
	...
	private final org.magneton.framework.core.design.chain.Chain chain;

	public static ChainRegistrar get(String chainId) {
		org.magneton.framework.core.design.chain.Chain existChain = ChainBus.getChain(chainId);
		if (existChain == null) {
	...
	public ChainRegistrar(org.magneton.framework.core.design.chain.Chain chain) {
		this.chain = chain;
	}
