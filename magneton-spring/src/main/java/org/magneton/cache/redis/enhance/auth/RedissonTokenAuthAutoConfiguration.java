...
// @ConditionalOnClass({ RedissonClient.class, MTokenAuth.class })
// public class RedissonTokenAuthAutoConfiguration {
//
// private static final String TOKEN_AUTH_KEY =
// MoreObjects.firstNonNull(System.getProperty("magneton.auth.token"),
// "M_AUTH_TOKEN");
//
// @Bean
// @ConditionalOnMissingBean
// public MTokenAuth tokenAuth(RedissonClient redissonClient) {
// return new RedissonMTokenAuth(redissonClient);
// }
//
// @SuppressWarnings("unchecked")
// public static class RedissonMTokenAuth implements MTokenAuth {
//
// private RedissonClient client;
//
// public RedissonMTokenAuth(RedissonClient redissonClient) {
...
// String token = Hashing.sha256().hashString(UUID.randomUUID().toString(),
