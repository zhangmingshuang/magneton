package org.magneton.redis.enhance.geo.redis;

import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;
import org.magneton.foundation.comparator.VersionComparator;
import org.magneton.redis.enhance.geo.Geo;
import org.magneton.redis.enhance.geo.GeoEntry;
...
class RedissonGeoTest extends TestRedisson {
	...
	private boolean isIgnore() {
		String version = redissonClient.getRedisNodes(RedisNodes.SINGLE)
			.getInstance()
	...
	void radiusWithDistance() {
		...
		PositionArgs args = new PositionArgs().setName("radiusWithDistance")
			.setPosition(118.188087, 24.494134)
			.setRadius(1000);
	...
	void radiusWithPosition() {
		...
		PositionArgs args = new PositionArgs().setName("radiusWithPosition")
			.setPosition(118.188087, 24.494134)
			.setRadius(1000);
