...
import org.magneton.enhance.pay.wxv3.annotation.WxSecret;
import org.magneton.enhance.pay.wxv3.core.BaseV3Data;
import org.magneton.enhance.pay.wxv3.core.WxReceiverType;
import org.magneton.enhance.pay.wxv3.core.WxRelationType;
...
@Getter
@ToString
public class WxProfitSharingReceiverAddReq extends BaseV3Data {
	 ...
	 * 类型是PERSONAL_OPENID时，是个人openid openid获取方法 示例值：86693852
	 */
	private String account;

	/**
	 * 分账个人接收方姓名 name string[1, 1024] 否
	 * body分账接收方类型是MERCHANT_ID时，是商户全称（必传），当商户是小微商户或个体户时，是开户人姓名
	 ...
	 * <li>4、将请求中HTTP头部的Wechatpay-Serial设置为证书序列号</li>
	 * </ul>
	 * 示例值：hu89ohu89ohu89o
	 */
	@Nullable
	 ...
	 * 当字段relation_type的值为CUSTOM时，本字段必填; 当字段relation_type的值不为CUSTOM时，本字段无需填写。 示例值：代理商
	 */
	@Nullable
