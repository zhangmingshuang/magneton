...
public interface WechatMiniProgram {
	 ...
	 * @return 登录凭证
	 */
	Consequences<MPCode2Session> code2Session(String code);
	 ...
	 * @return 手机号
	 */
	Consequences<MPPhoneInfo> getPhoneNumber(String code);
	 ...
	 * @return
	 */
	Consequences<MPSensitiveUserInfo> decodeUserInfo(String sessionKey, MPUserInfo userInfo);
