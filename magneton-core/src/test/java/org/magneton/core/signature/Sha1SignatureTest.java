...
class Sha1SignatureTest {
  ...
  void getSignatureBodyVerifyer() {
    ...
    Assertions.assertNull(
        sha1Signature.getSignatureBodyVerifyer(), "signature body verifyer default must be null");
    KeysSignatureBodyVerifyer keysSignatureBodyVerifyer =
        new KeysSignatureBodyVerifyer(new String[] {"a", "b"});
    sha1Signature.setSignatureBodyVerifyer(keysSignatureBodyVerifyer);
    Assertions.assertEquals(
        keysSignatureBodyVerifyer,
        sha1Signature.getSignatureBodyVerifyer(),
