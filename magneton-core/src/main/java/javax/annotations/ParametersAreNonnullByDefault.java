...
/**
 * This annotation can be applied to a package, class or method to indicate that the
 * method parameters in that element are nonnull by default unless there is:
 * <ul>
 ...
 * {@link ParametersAreNullableByDefault}) applied to a more tightly nested element.
 * </ul>
 *
