 ...
 * interface, but that are not supported. One example is the implementation of
 * {@link java.util.Collection#add} in an immutable collection implementation.
 *
 * <p>
 * Marking methods annotated with {@code @DoNotCall} as {@code @Deprecated} is
