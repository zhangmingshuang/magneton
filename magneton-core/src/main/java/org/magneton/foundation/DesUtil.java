...
public class DesUtil {
	...
	private static final String PASSWORD_CRYPT_KEY = RuntimeArgs.sys("DES_SECRET").getOrDefault("magneton");
	...
	public static final boolean isDecryptable(String data) {
		return isDecryptable(data, PASSWORD_CRYPT_KEY);
	}

	public static final boolean isDecryptable(String data, String password) {
