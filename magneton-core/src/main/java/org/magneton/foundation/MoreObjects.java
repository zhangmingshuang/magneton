...
public class MoreObjects {
	 ...
	 * <p>
	 * Builds a String representation of the contents in case of an array. Returns a
	 * {@code "null"} String if {@code obj} is {@code null}.
	 ...
	 * {@code ", "} (a comma followed by a space). Returns a {@code "null"} String if
