 ...
 *
 * <p>
 * To attach to a {@link ListenableFuture} use {@link Futures#addCallback}.
 *
 * @author Anthony Zana
 * @since 10.0
 */
...
public interface FutureCallback<V extends Object> {
	 ...
	 *
	 * <p>
	 * If the future's {@link Future#get() get} method throws an
	 * {@link ExecutionException}, then the cause is passed to this method. Any other
