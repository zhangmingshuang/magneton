...
import static org.magneton.foundation.util.concurrent.NullnessCasts.uncheckedCastNullableTToT;
import static org.magneton.foundation.util.concurrent.Platform.isInstanceOfThrowableClass;
...
abstract class AbstractCatchingFuture<V extends Object, X extends Throwable, F, T extends Object>
	...
	private static final class AsyncCatchingFuture<V extends Object, X extends Throwable> extends
			AbstractCatchingFuture<V, X, AsyncFunction<? super X, ? extends V>, ListenableFuture<? extends V>> {
