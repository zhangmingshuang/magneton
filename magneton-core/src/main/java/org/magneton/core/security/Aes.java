...
public class Aes {
	 ...
	 * @throws IllegalStateException if skey is not valid and GCM mode is not available in
	 * the JRE.
	 */
	...
	public static String encrypt(SecretKey skey, String plaintext) {
		...
		catch (NoSuchPaddingException | InvalidAlgorithmParameterException | ShortBufferException | BadPaddingException
	 ...
	 * @throws BadPaddingException if these indicate corrupt or malicious ciphertext. Note
	 * that AEADBadTagException may be thrown in GCM mode; this is a subclass of
	 * BadPaddingException.
	 * @throws IllegalBlockSizeException if these indicate corrupt or malicious
	 * ciphertext.
	 * @throws IllegalStateException if skey is not valid and GCM mode is not available in
	 * the JRE.
	 */
