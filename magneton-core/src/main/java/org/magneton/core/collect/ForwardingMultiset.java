...
/**
 * A multiset which forwards all its method calls to another multiset. Subclasses should
 * override one or more methods to modify the behavior of the backing multiset as desired
 ...
 * implementations invoke methods, they invoke methods on the {@code ForwardingMultiset}.
 *
 * <p>
...
public abstract class ForwardingMultiset<E extends Object> extends ForwardingCollection<E> implements Multiset<E> {
	 ...
	 * override {@link #count}, you may wish to override {@link #contains} to forward to
	 * this implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * {@link #entrySet}. If you override {@link #entrySet}, you may wish to override
	 * {@link #count} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * {@link #add(Object, int)}. If you override {@link #add(Object, int)}, you may wish
	 * to override {@link #add(Object)} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * {@link #add(Object)} and {@link #add(Object, int)}. If you override either of these
	 * methods, you may wish to override {@link #addAll(Collection)} to forward to this
	 * implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * {@link #remove(Object, int)}. If you override {@link #remove(Object, int)}, you may
	 * wish to override {@link #remove(Object)} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	@Override
	...
	/**
	 * A sensible definition of {@link #removeAll} in terms of the {@code removeAll}
	 * method of {@link #elementSet}. If you override {@link #elementSet}, you may wish to
	...
	/**
	 * A sensible definition of {@link #retainAll} in terms of the {@code retainAll}
	 * method of {@link #elementSet}. If you override {@link #elementSet}, you may wish to
	 * override {@link #retainAll} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	@Override
	 ...
	 * {@link #remove(Object, int)}. {@link #entrySet()}. If you override any of these
	 * methods, you may wish to override {@link #setCount(Object, int)} to forward to this
	 * implementation.
	 *
	 * @since 7.0
	 */
	protected int standardSetCount(@ParametricNullness E element, int count) {
		return org.magneton.core.collect.Multisets.setCountImpl(this, element, count);
	}

	/**
	 * A sensible definition of {@link #setCount(Object, int, int)} in terms of
	 * {@link #count(Object)} and {@link #setCount(Object, int)}. If you override either
	 * of these methods, you may wish to override {@link #setCount(Object, int, int)} to
	 * forward to this implementation.
	 *
	 * @since 7.0
	 */
	protected boolean standardSetCount(@ParametricNullness E element, int oldCount, int newCount) {
		return org.magneton.core.collect.Multisets.setCountImpl(this, element, oldCount, newCount);
	}

	/**
	 * A sensible definition of {@link #iterator} in terms of {@link #entrySet} and
	 * {@link #remove(Object)}. If you override either of these methods, you may wish to
	 * override {@link #iterator} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * {@link #entrySet}. If you override {@link #entrySet}, you may wish to override
	 * {@link #size} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	protected int standardSize() {
		return org.magneton.core.collect.Multisets.linearTimeSizeImpl(this);
	}

	/**
	 * A sensible, albeit inefficient, definition of {@link #equals} in terms of {@code
	 * entrySet().size()} and {@link #count}. If you override either of these methods, you
	...
	/**
	 * A sensible definition of {@link #hashCode} as {@code entrySet().hashCode()} . If
	 * you override {@link #entrySet}, you may wish to override {@link #hashCode} to
	 * forward to this implementation.
	 *
	 * @since 7.0
	 */
	...
	/**
	 * A sensible definition of {@link #toString} as {@code entrySet().toString()} . If
	 * you override {@link #entrySet}, you may wish to override {@link #toString} to
	 * forward to this implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * methods: {@link ForwardingMultiset#clear}, {@link ForwardingMultiset#contains},
	 * {@link ForwardingMultiset#containsAll}, {@link ForwardingMultiset#count},
	 * {@link ForwardingMultiset#isEmpty}, the {@link Set#size} and {@link Set#iterator}
	 * methods of {@link ForwardingMultiset#entrySet}, and
	 * {@link ForwardingMultiset#remove(Object, int)}. In many situations, you may wish to
	 * override {@link ForwardingMultiset#elementSet} to forward to this implementation or
	 * a subclass thereof.
	 *
	 * @since 10.0
	 */

	protected class StandardElementSet extends org.magneton.core.collect.Multisets.ElementSet<E> {
		...
		public Iterator<E> iterator() {
			return org.magneton.core.collect.Multisets.elementIterator(multiset().entrySet().iterator());
		}
