 ...
 *
 * <p>
 * <b>Warning:</b> The methods of {@code ForwardingList} forward <b>indiscriminately</b>
 * to the methods of the delegate. For example, overriding {@link #add} alone <b>will
 * not</b> change the behavior of {@link #addAll}, which can lead to unexpected behavior.
 * In this case, you should override {@code addAll} as well, either providing your own
 ...
 * implementations invoke methods, they invoke methods on the {@code ForwardingList}.
 *
 * <p>
...
public abstract class ForwardingList<E extends Object> extends ForwardingCollection<E> implements List<E> {
	 ...
	 * {@link #add(int, Object)}. If you override {@link #add(int, Object)}, you may wish
	...
	/**
	 * A sensible default implementation of {@link #addAll(int, Collection)}, in terms of
	 * the {@code
	 * add} method of {@link #listIterator(int)}. If you override
	 * {@link #listIterator(int)}, you may wish to override
	 ...
	 * {@link #listIterator()}. If you override {@link #listIterator()}, you may wish to
	 ...
	 * {@link #listIterator(int)}. If you override {@link #listIterator(int)}, you may
	 * wish to override {@link #lastIndexOf} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * {@link #listIterator(int)}. If you override {@link #listIterator(int)}, you may
	 * wish to override {@link #listIterator()} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	 ...
	 * {@link #add(int, Object)}, and {@link #remove(int)}. If you override any of these
	 * methods, you may wish to override {@link #listIterator(int)} to forward to this
	 * implementation.
	 *
	 * @since 7.0
	 */
	...
	/**
	 * A sensible default implementation of {@link #subList(int, int)}. If you override
	 * any other methods, you may wish to override {@link #subList(int, int)} to forward
	...
	/**
	 * A sensible definition of {@link #equals(Object)} in terms of {@link #size} and
	 * {@link #iterator}. If you override either of those methods, you may wish to
	 * override {@link #equals(Object)} to forward to this implementation.
	 *
	 * @since 7.0
	 */
	...
	/**
	 * A sensible definition of {@link #hashCode} in terms of {@link #iterator}. If you
	 * override {@link #iterator}, you may wish to override {@link #hashCode} to forward
	 * to this implementation.
	 *
	 * @since 7.0
	 */
