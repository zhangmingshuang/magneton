...
abstract class AbstractNavigableMap<K extends Object, V extends Object> extends Maps.IteratorBasedAbstractMap<K, V>
	...
	public Entry<K, V> firstEntry() {
		return org.magneton.core.collect.Iterators.getNext(entryIterator(), null);
	}

	@Override
	@CheckForNull
	public Entry<K, V> lastEntry() {
		return org.magneton.core.collect.Iterators.getNext(descendingEntryIterator(), null);
	}

	@Override
	@CheckForNull
	public Entry<K, V> pollFirstEntry() {
		return org.magneton.core.collect.Iterators.pollNext(entryIterator());
	}
