...
/**
 * Multiset implementation specialized for enum elements, supporting all single-element
 * operations in O(1).
 *
 * <p>
...
public final class EnumMultiset<E extends Enum<E>> extends AbstractMultiset<E> implements Serializable {
	 ...
	 * {@link EnumMultiset#create(Iterable)}, this method does not produce an exception on
	 * an empty iterable.
	 *
	 * @since 14.0
	 */
	 ...
	 * Otherwise, throws either a NullPointerException or a ClassCastException as
	 * appropriate.
	 */
	 ...
	 * elements, the first element, its count, the second element, its count, and so on
	 */
