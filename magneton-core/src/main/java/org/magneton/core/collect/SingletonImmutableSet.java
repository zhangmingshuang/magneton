...
/**
 * Implementation of {@link org.magneton.core.collect.ImmutableSet} with exactly one
 * element.
 *
...
final class SingletonImmutableSet<E> extends ImmutableSet<E> {
	...
	// compressed oops, a SingletonImmutableSet packs all the way down to the optimal 16
	// bytes.
