...
/**
 * A deque which forwards all its method calls to another deque. Subclasses should
 * override one or more methods to modify the behavior of the backing deque as desired per
 * the <a href="http://en.wikipedia.org/wiki/Decorator_pattern">decorator pattern</a>.
 *
 * <p>
 * <b>Warning:</b> The methods of {@code ForwardingDeque} forward <b>indiscriminately</b>
 ...
 * this case, you should override {@code offer} as well.
 *
 * <p>
 ...
 * implementations invoke methods, they invoke methods on the {@code ForwardingDeque}.
 *
