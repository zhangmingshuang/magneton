 ...
 * {@link org.magneton.core.collect.ImmutableBiMap} equivalents with deprecated,
 * exception-throwing versions. See {@link ImmutableSortedSetFauxverideShim} for details.
 *
 * @author Louis Wasserman
 */
@ElementTypesAreNonnullByDefault
abstract class ImmutableBiMapFauxverideShim<K, V> extends org.magneton.core.collect.ImmutableMap<K, V> {

	/**
	 * Not supported. Use
	 * {@link org.magneton.core.collect.ImmutableBiMap#toImmutableBiMap} instead. This
	 * method exists only to hide
	 * {@link org.magneton.core.collect.ImmutableMap#toImmutableMap(Function, Function)}
	...
	/**
	 * Not supported. This method does not make sense for {@code BiMap}. This method
	 * exists only to hide
	 * {@link org.magneton.core.collect.ImmutableMap#toImmutableMap(Function, Function, BinaryOperator)}
	 * from consumers of {@code ImmutableBiMap}.
	 * @throws UnsupportedOperationException always
	 * @deprecated
	 */
	@Deprecated
