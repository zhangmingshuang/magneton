...
/**
 * A {@link org.magneton.core.collect.SortedMultiset} whose contents will never change,
 * with many other important properties detailed at {@link ImmutableCollection}.
 *
 * <p>
...
public abstract class ImmutableSortedMultiset<E> extends ImmutableSortedMultisetFauxverideShim<E>
	 ...
	 *
	 * <p>
	 * <b>Warning:</b> {@code comparator} should be <i>consistent with {@code equals}</i>
	 * as explained in the {@link Comparator} documentation.
	 *
	 * @since 21.0
	 */
	 ...
	 * {@code ImmutableSortedMultiset} whose elements are the result of applying
	 * {@code elementFunction} to the inputs, with counts equal to the result of applying
	 * {@code countFunction} to the inputs.
	 *
	 * <p>
	 * If the mapped elements contain duplicates (according to {@code comparator}), the
	 ...
	 * @since 22.0
	 */
	public static <T extends Object, E> Collector<T, ?, ImmutableSortedMultiset<E>> toImmutableSortedMultiset(
			Comparator<? super E> comparator, Function<? super T, ? extends E> elementFunction,
			ToIntFunction<? super T> countFunction) {
		Preconditions.checkNotNull(comparator);
		Preconditions.checkNotNull(elementFunction);
		Preconditions.checkNotNull(countFunction);
		return Collector.of(
				() -> org.magneton.core.collect.TreeMultiset.create(comparator), (multiset, t) -> multiset
						.add(Preconditions.checkNotNull(elementFunction.apply(t)), countFunction.applyAsInt(t)),
				(multiset1, multiset2) -> {
	...
	public static <E extends Comparable<? super E>> ImmutableSortedMultiset<E> of(E element) {
		RegularImmutableSortedSet<E> elementSet = (RegularImmutableSortedSet<E>) org.magneton.core.collect.ImmutableSortedSet
				.of(element);
	...
	/**
	 * Returns an immutable sorted multiset containing the given elements sorted by their
	 * natural ordering.
	...
	/**
	 * Returns an immutable sorted multiset containing the given elements sorted by their
	 * natural ordering. To create a copy of a {@code SortedMultiset} that preserves the
	 * comparator, call {@link #copyOfSorted} instead. This method iterates over
	 * {@code elements} at most once.
	 *
	 * <p>
	 * Note that if {@code s} is a {@code Multiset<String>}, then {@code
	 * ImmutableSortedMultiset.copyOf(s)} returns an
	 * {@code ImmutableSortedMultiset<String>} containing each of the strings in
	 * {@code s}, while {@code ImmutableSortedMultiset.of(s)} returns an
	 * {@code ImmutableSortedMultiset<Multiset<String>>} containing one element (the given
	 * multiset itself).
	 *
	 * <p>
	...
	/**
	 * Returns an immutable sorted multiset containing the given elements sorted by the
	 * given {@code
	 * Comparator}.
	...
	public static <E> ImmutableSortedMultiset<E> copyOf(Comparator<? super E> comparator,
		...
		if (elements instanceof ImmutableSortedMultiset) {
			// immutable collections are always safe for
			// covariant casts
		...
		org.magneton.core.collect.TreeMultiset<E> sortedCopy = org.magneton.core.collect.TreeMultiset
				.create(Preconditions.checkNotNull(comparator));
	 ...
	 * {@link #copyOf(Iterable)}, which always uses the natural ordering of the elements.
	 *
	 * <p>
	 * Despite the method name, this method attempts to avoid actually copying the data
	 * when it is safe to do so. The exact circumstances under which a copy will or will
	 ...
	 *
	 * <p>
	 * This method is safe to use even when {@code sortedMultiset} is a synchronized or
	 * concurrent collection that is currently being modified by another thread.
	 * @throws NullPointerException if {@code sortedMultiset} or any of its elements is
	 * null
	 */
	public static <E> ImmutableSortedMultiset<E> copyOfSorted(
			org.magneton.core.collect.SortedMultiset<E> sortedMultiset) {
	...
	private static <E> ImmutableSortedMultiset<E> copyOfSortedEntries(Comparator<? super E> comparator,
		...
		org.magneton.core.collect.ImmutableList.Builder<E> elementsBuilder = new ImmutableList.Builder<E>(
				entries.size());
		...
		return new RegularImmutableSortedMultiset<E>(
				new RegularImmutableSortedSet<E>(elementsBuilder.build(), comparator), cumulativeCounts, 0,
				entries.size());
	}
	 ...
	 * comparator. If the comparator has a more general type than the set being generated,
	 * such as creating a {@code
	...
	/**
	 * Returns a builder that creates immutable sorted multisets whose elements are
	 ...
	 * <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6468354">bug
	 * 6468354</a>.
	 */
	...
	/**
	 * Returns a builder that creates immutable sorted multisets whose elements are
	 * ordered by their natural ordering. The sorted multisets use
	 * {@link Ordering#natural()} as the comparator. This method provides more type-safety
	 * than {@link #builder}, as it can be called only for classes that implement
	 * {@link Comparable}.
	 *
	 * <p>
	 * Note: the type parameter {@code E} extends {@code Comparable<?>} rather than {@code
	...
	public ImmutableSortedMultiset<E> descendingMultiset() {
		...
		if (result == null) {
			return descendingMultiset = isEmpty() ? emptyMultiset(Ordering.from(comparator()).reverse())
	 ...
	 *
	 * <p>
	 * This implementation is guaranteed to throw an
	...
	@Override
	public ImmutableSortedMultiset<E> subMultiset(E lowerBound, org.magneton.core.collect.BoundType lowerBoundType,
			E upperBound, org.magneton.core.collect.BoundType upperBoundType) {
		Preconditions.checkArgument(comparator().compare(lowerBound, upperBound) <= 0,
	...
	public static class Builder<E> extends ImmutableMultiset.Builder<E> {
		...
		public Builder(Comparator<? super E> comparator) {
			super(TreeMultiset.<E>create(Preconditions.checkNotNull(comparator)));
		}
		...
		/**
		 * Returns a newly-created {@code ImmutableSortedMultiset} based on the contents
		 * of the {@code
		 * Builder}.
		 */
		@Override
		public ImmutableSortedMultiset<E> build() {
			return copyOfSorted((org.magneton.core.collect.SortedMultiset<E>) contents);
		}
