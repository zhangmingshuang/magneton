...
public final class HashMultiset<E extends Object> extends AbstractMapBasedMultiset<E> {
	...
	/**
	 * Creates a new, empty {@code HashMultiset} with the specified expected number of
	 * distinct elements.
	 ...
	 */
	public static <E extends Object> HashMultiset<E> create(Iterable<? extends E> elements) {
