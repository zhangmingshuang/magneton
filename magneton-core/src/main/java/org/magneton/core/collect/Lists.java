...
import static org.magneton.core.base.Preconditions.checkElementIndex;
import static org.magneton.core.base.Preconditions.checkNotNull;
import static org.magneton.core.base.Preconditions.checkPositionIndex;
...
public final class Lists {
	 ...
	 * {@link org.magneton.core.collect.ImmutableList#of()} instead.
	 *
	 * <p>
	 ...
	 * {@link org.magneton.core.collect.ImmutableList#of()} (for varargs) or
	 * {@link org.magneton.core.collect.ImmutableList#copyOf(Object[])} (for an array)
	 * instead. If any elements might be null, or you need support for
	 ...
	 * {@link org.magneton.core.collect.Iterables#addAll}.
	 *
	 * <p>
	 * <b>Note:</b> if mutability is not required and the elements are non-null, use
	 * {@link org.magneton.core.collect.ImmutableList#copyOf(Iterable)} instead. (Or,
	 * change {@code elements} to be a {@link org.magneton.core.collect.FluentIterable}
	 * and call {@code elements.toList()}.)
	 *
	 * <p>
	 * <b>Note:</b> if {@code elements} is a {@link Collection}, you don't need this
	 * method. Use the {@code ArrayList} {@linkplain ArrayList#ArrayList(Collection)
	 ...
	 * <p>
	 * <b>Note:</b> if mutability is not required and the elements are non-null, use
	 * {@link org.magneton.core.collect.ImmutableList#copyOf(Iterator)} instead.
	 */
	public static <E extends Object> ArrayList<E> newArrayList(Iterator<? extends E> elements) {
		ArrayList<E> list = newArrayList();
		org.magneton.core.collect.Iterators.addAll(list, elements);
		return list;
	}
	 ...
	 * <p>
	 * <b>Note:</b> this method is now unnecessary and should be treated as deprecated.
	 * Instead, use {@code new }{@link ArrayList#ArrayList(int) ArrayList}{@code <>(int)}
	 * directly, taking advantage of <a href="http://goo.gl/iz2Wi">"diamond" syntax</a>.
	 * (Unlike here, there is no risk of overload ambiguity, since the {@code ArrayList}
	...
	public static <E extends Object> ArrayList<E> newArrayListWithCapacity(int initialArraySize) {
		CollectPreconditions.checkNonnegative(initialArraySize, "initialArraySize"); // for
																						// GWT.
	 ...
	 * <p>
	 * <b>Note:</b> this method is now unnecessary and should be treated as deprecated.
	 * Instead, use the {@code LinkedList} {@linkplain LinkedList#LinkedList()
	 * constructor} directly, taking advantage of <a href="http://goo.gl/iz2Wi">"diamond"
	 * syntax</a>.
	 */
	 ...
	 * <p>
	 * <b>Note:</b> if {@code elements} is a {@link Collection}, you don't need this
	 * method. Use the {@code LinkedList} {@linkplain LinkedList#LinkedList(Collection)
	 * constructor} directly, taking advantage of <a href="http://goo.gl/iz2Wi">"diamond"
	 * syntax</a>.
	 */
	public static <E extends Object> LinkedList<E> newLinkedList(Iterable<? extends E> elements) {
		LinkedList<E> list = newLinkedList();
		org.magneton.core.collect.Iterables.addAll(list, elements);
		return list;
	}
	...
	public static <E extends Object> CopyOnWriteArrayList<E> newCopyOnWriteArrayList(Iterable<? extends E> elements) {
	 ...
	 * @return an unmodifiable list containing the specified elements
	 */
	public static <E extends Object> List<E> asList(@ParametricNullness E first, @ParametricNullness E second,
			E[] rest) {
	 ...
	 * the given lists in order; the "n-ary
	 ...
	 *
	 * <p>
	 * Note that if any input list is empty, the Cartesian product will also be empty. If
	 * no lists at all are provided (an empty list), the resulting Cartesian product has
	 ...
	 * {@code m, n, p} is a list of size {@code m x n x p}, its actual memory consumption
	 * is much smaller. When the cartesian product is constructed, the input lists are
	 * merely copied. Only as the resulting list is iterated are the individual lists
	 * created, and these are not retained after iteration.
	 * @param lists the lists to choose elements from, in the order that the elements
	 * chosen from those lists should appear in the resulting lists
	 ...
	 * @throws IllegalArgumentException if the size of the cartesian product would be
	 * greater than {@link Integer#MAX_VALUE}
	 * @throws NullPointerException if {@code lists}, any one of the {@code lists}, or any
	 * element of a provided list is null
	 * @since 19.0
	 */
	public static <B> List<List<B>> cartesianProduct(List<? extends List<? extends B>> lists) {
		return org.magneton.core.collect.CartesianList.create(lists);
	}
	 ...
	 * {@link org.magneton.core.collect.ImmutableList#copyOf(Collection)} (for example),
	 ...
	 */
	public static <F extends Object, T extends Object> List<T> transform(List<F> fromList,
	...
	/**
	 * Returns a view of the specified string as an immutable list of {@code Character}
	 * values.
	 *
	 * @since 7.0
	 */
	public static org.magneton.core.collect.ImmutableList<Character> charactersOf(String string) {
		return new StringAsImmutableList(checkNotNull(string));
	}

	/**
	 * Returns a view of the specified {@code CharSequence} as a {@code List<Character>},
	 * viewing {@code sequence} as a sequence of Unicode code units. The view does not
	 * support any modification operations, but reflects any changes to the underlying
	 * character sequence.
	...
	public static <T> List<T> reverse(List<T> list) {
		if (list instanceof org.magneton.core.collect.ImmutableList) {
	...
	static <E extends Object> boolean addAllImpl(List<E> list, int index, Iterable<? extends E> elements) {
	...
	static <E extends Object> List<E> subListImpl(List<E> list, int fromIndex, int toIndex) {
		List<E> wrapper;
		if (list instanceof RandomAccess) {
	...
	private static class TransformingSequentialList<F extends Object, T extends Object>
		...
		public ListIterator<T> listIterator(int index) {
			return new org.magneton.core.collect.TransformedListIterator<F, T>(fromList.listIterator(index)) {
				@Override
				@ParametricNullness
	 ...
	 * @see Lists#transform
	 */
	private static class TransformingRandomAccessList<F extends Object, T extends Object> extends AbstractList<T>
	...
	// serialized using ImmutableList serialization
	private static final class StringAsImmutableList extends org.magneton.core.collect.ImmutableList<Character> {
		...
		@Override
		public org.magneton.core.collect.ImmutableList<Character> subList(int fromIndex, int toIndex) {
