 ...
 * {@link ArrayListMultimap}. The GWT supersource for this class contains a field for each
 * type.
 *
 * <p>
...
abstract class ArrayListMultimapGwtSerializationDependencies<K, V> extends AbstractListMultimap<K, V> {
	...
	// TODO(cpovirk): Maybe I should have just one shared superclass for AbstractMultimap
	// itself?
