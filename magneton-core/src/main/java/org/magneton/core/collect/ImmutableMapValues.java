...
/**
 * {@code values()} implementation for {@link org.magneton.core.collect.ImmutableMap}.
 *
 * @author Jesse Wilson
...
final class ImmutableMapValues<K, V> extends ImmutableCollection<V> {
	...
	ImmutableMapValues(org.magneton.core.collect.ImmutableMap<K, V> map) {
		this.map = map;
	}
	...
	@Override
	public org.magneton.core.collect.ImmutableList<V> asList() {
		ImmutableList<Entry<K, V>> entryList = map.entrySet().asList();
		return new org.magneton.core.collect.ImmutableAsList<V>() {
			@Override
