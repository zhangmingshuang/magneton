...
/**
 * A {@link org.magneton.core.collect.ClassToInstanceMap} whose contents will never
 * change, with many other important properties detailed at {@link ImmutableCollection}.
 *
...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B>
	...
	private static final ImmutableClassToInstanceMap<Object> EMPTY = new ImmutableClassToInstanceMap<>(
			org.magneton.core.collect.ImmutableMap.<Class<?>, Object>of());

	private final org.magneton.core.collect.ImmutableMap<Class<? extends B>, B> delegate;
	...
	public static <B, T extends B> ImmutableClassToInstanceMap<B> of(Class<T> type, T value) {
		org.magneton.core.collect.ImmutableMap<Class<? extends B>, B> map = org.magneton.core.collect.ImmutableMap
				.<Class<? extends B>, B>of(type, value);
	...
	/**
	 * Returns an immutable map containing the same entries as {@code map}. If {@code map}
	 ...
	 *
	 * <p>
	 * <b>Note:</b> Despite what the method name suggests, if {@code map} is an {@code
	 * ImmutableClassToInstanceMap}, no copy will actually be performed.
	 * @throws NullPointerException if any key or value in {@code map} is null
	 * @throws ClassCastException if any value is not an instance of the type specified by
	 * its key
	 */
	...
	public static final class Builder<B> {
		...
		private final org.magneton.core.collect.ImmutableMap.Builder<Class<? extends B>, B> mapBuilder = org.magneton.core.collect.ImmutableMap
				.builder();
		...
		public ImmutableClassToInstanceMap<B> build() {
			org.magneton.core.collect.ImmutableMap<Class<? extends B>, B> map = mapBuilder.build();
			if (map.isEmpty()) {
				return of();
			}
			else {
