...
final class CollectSpliterators {
	...
	/**
	 * Returns a {@code Spliterator} over the elements of {@code fromSpliterator} mapped
	 * by {@code
	 * function}.
	 */
	static <InElementT extends Object, OutElementT extends Object> Spliterator<OutElementT> map(
	...
	/**
	 * Returns a {@code Spliterator} that iterates over the elements of the spliterators
	 * generated by applying {@code function} to the elements of {@code fromSpliterator}.
	 */
	static <InElementT extends Object, OutElementT extends Object> Spliterator<OutElementT> flatMap(
			Spliterator<InElementT> fromSpliterator, Function<? super InElementT, Spliterator<OutElementT>> function,
			int topCharacteristics, long topSize) {
		Preconditions.checkArgument((topCharacteristics & Spliterator.SUBSIZED) == 0,
				"flatMap does not support SUBSIZED characteristic");
		Preconditions.checkArgument((topCharacteristics & Spliterator.SORTED) == 0,
	...
	/**
	 * Returns a {@code Spliterator.OfInt} that iterates over the elements of the
	 * spliterators generated by applying {@code function} to the elements of
	 * {@code fromSpliterator}. (If {@code
	 * function} returns {@code null} for an input, it is replaced with an empty stream.)
	 */
	static <InElementT extends Object> Spliterator.OfInt flatMapToInt(Spliterator<InElementT> fromSpliterator,
			Function<? super InElementT, Spliterator.OfInt> function, int topCharacteristics, long topSize) {
		Preconditions.checkArgument((topCharacteristics & Spliterator.SUBSIZED) == 0,
				"flatMap does not support SUBSIZED characteristic");
		Preconditions.checkArgument((topCharacteristics & Spliterator.SORTED) == 0,
				"flatMap does not support SORTED characteristic");
	...
	/**
	 * Returns a {@code Spliterator.OfLong} that iterates over the elements of the
	 * spliterators generated by applying {@code function} to the elements of
	 * {@code fromSpliterator}. (If {@code
	 * function} returns {@code null} for an input, it is replaced with an empty stream.)
	 */
	static <InElementT extends Object> Spliterator.OfLong flatMapToLong(Spliterator<InElementT> fromSpliterator,
			Function<? super InElementT, Spliterator.OfLong> function, int topCharacteristics, long topSize) {
		Preconditions.checkArgument((topCharacteristics & Spliterator.SUBSIZED) == 0,
				"flatMap does not support SUBSIZED characteristic");
		Preconditions.checkArgument((topCharacteristics & Spliterator.SORTED) == 0,
				"flatMap does not support SORTED characteristic");
	...
	/**
	 * Returns a {@code Spliterator.OfDouble} that iterates over the elements of the
	 * spliterators generated by applying {@code function} to the elements of
	 * {@code fromSpliterator}. (If {@code
	 * function} returns {@code null} for an input, it is replaced with an empty stream.)
	 */
	static <InElementT extends Object> Spliterator.OfDouble flatMapToDouble(Spliterator<InElementT> fromSpliterator,
			Function<? super InElementT, Spliterator.OfDouble> function, int topCharacteristics, long topSize) {
		Preconditions.checkArgument((topCharacteristics & Spliterator.SUBSIZED) == 0,
				"flatMap does not support SUBSIZED characteristic");
		Preconditions.checkArgument((topCharacteristics & Spliterator.SORTED) == 0,
				"flatMap does not support SORTED characteristic");
	 ...
	 */
	abstract static class FlatMapSpliterator<InElementT extends Object, OutElementT extends Object, OutSpliteratorT extends Spliterator<OutElementT>>
		...
		FlatMapSpliterator(@CheckForNull OutSpliteratorT prefix, Spliterator<InElementT> from,
				Function<? super InElementT, OutSpliteratorT> function, Factory<InElementT, OutSpliteratorT> factory,
		...
		/*
		 * The tryAdvance and forEachRemaining in FlatMapSpliteratorOfPrimitive are
		 * overloads of these methods, not overrides. They are annotated @Override because
		 * they implement methods from Spliterator.OfPrimitive (and override default
		 * implementations from Spliterator.OfPrimitive or a subtype like
		 * Spliterator.OfInt).
		 */
		...
		public final void forEachRemaining(Consumer<? super OutElementT> action) {
			...
			from.forEachRemaining(fromElement -> {
		...
		public final OutSpliteratorT trySplit() {
			...
			if (fromSplit != null) {
				...
				if (estSplitSize < Long.MAX_VALUE) {
					estSplitSize /= 2;
					estimatedSize -= estSplitSize;
					characteristics = splitCharacteristics;
				}
				OutSpliteratorT result = factory.newFlatMapSpliterator(prefix, fromSplit, function,
						splitCharacteristics, estSplitSize);
				prefix = null;
				return result;
			}
			else if (prefix != null) {
		...
		interface Factory<InElementT extends Object, OutSpliteratorT extends Spliterator<?>> {
			...
			OutSpliteratorT newFlatMapSpliterator(@CheckForNull OutSpliteratorT prefix,
					Spliterator<InElementT> fromSplit, Function<? super InElementT, OutSpliteratorT> function,
					int splitCharacteristics, long estSplitSize);
	 ...
	 *
	 * <p>
	 * To avoid having this type, we could use {@code FlatMapSpliterator} directly. The
	 * main advantages to having the type are the ability to use its constructor reference
	 * below and the parallelism with the primitive version. In short, it makes its caller
	 * ({@code flatMap}) simpler.
	 *
	 * @param <InElementT> the element type of the input spliterator
	 * @param <OutElementT> the element type of the output spliterators
	 */
	static final class FlatMapSpliteratorOfObject<InElementT extends Object, OutElementT extends Object>
			extends FlatMapSpliterator<InElementT, OutElementT, Spliterator<OutElementT>> {

		FlatMapSpliteratorOfObject(@CheckForNull Spliterator<OutElementT> prefix, Spliterator<InElementT> from,
				Function<? super InElementT, Spliterator<OutElementT>> function, int characteristics,
				long estimatedSize) {
	 ...
	 * @param <OutSpliteratorT> the primitive spliterator type associated with
	 * {@code OutElementT}
	 */
	abstract static class FlatMapSpliteratorOfPrimitive<InElementT extends Object, OutElementT extends Object, OutConsumerT, OutSpliteratorT extends Spliterator.OfPrimitive<OutElementT, OutConsumerT, OutSpliteratorT>>
		...
		FlatMapSpliteratorOfPrimitive(@CheckForNull OutSpliteratorT prefix, Spliterator<InElementT> from,
				Function<? super InElementT, OutSpliteratorT> function, Factory<InElementT, OutSpliteratorT> factory,
				int characteristics, long estimatedSize) {
	...
	static final class FlatMapSpliteratorOfInt<InElementT extends Object>
		...
		FlatMapSpliteratorOfInt(@CheckForNull OfInt prefix, Spliterator<InElementT> from,
				Function<? super InElementT, OfInt> function, int characteristics, long estimatedSize) {
	...
	static final class FlatMapSpliteratorOfLong<InElementT extends Object>
		...
		FlatMapSpliteratorOfLong(@CheckForNull OfLong prefix, Spliterator<InElementT> from,
				Function<? super InElementT, OfLong> function, int characteristics, long estimatedSize) {
	...
	static final class FlatMapSpliteratorOfDouble<InElementT extends Object>
		...
		FlatMapSpliteratorOfDouble(@CheckForNull OfDouble prefix, Spliterator<InElementT> from,
				Function<? super InElementT, OfDouble> function, int characteristics, long estimatedSize) {
