...
final class DescendingImmutableSortedMultiset<E> extends org.magneton.core.collect.ImmutableSortedMultiset<E> {

	private final transient org.magneton.core.collect.ImmutableSortedMultiset<E> forward;

	DescendingImmutableSortedMultiset(org.magneton.core.collect.ImmutableSortedMultiset<E> forward) {
	...
	@Override
	public org.magneton.core.collect.ImmutableSortedMultiset<E> descendingMultiset() {
		return forward;
	}
