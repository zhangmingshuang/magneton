...
final class SortedIterables {
	...
	public static boolean hasSameComparator(Comparator<?> comparator, Iterable<?> elements) {
		...
		else if (elements instanceof org.magneton.core.collect.SortedIterable) {
			comparator2 = ((org.magneton.core.collect.SortedIterable<?>) elements).comparator();
		}
		else {
			return false;
		}
	...
	public static <E extends Object> Comparator<? super E> comparator(SortedSet<E> sortedSet) {
