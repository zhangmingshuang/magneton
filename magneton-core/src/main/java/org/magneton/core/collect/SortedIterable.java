...
/**
 * An {@code Iterable} whose elements are sorted relative to a {@code Comparator},
...
interface SortedIterable<T> extends Iterable<T> {
	...
	/**
	 * Returns the {@code Comparator} by which the elements of this iterable are ordered,
	 * or {@code
