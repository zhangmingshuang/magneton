...
/**
 * An iterator that transforms a backing list iterator; for internal use. This avoids the
 * object overhead of constructing a {@link Function} for internal methods.
 *
 * @author Louis Wasserman
 */
@ElementTypesAreNonnullByDefault
abstract class TransformedListIterator<F extends Object, T extends Object>
		extends org.magneton.core.collect.TransformedIterator<F, T> implements ListIterator<T> {
