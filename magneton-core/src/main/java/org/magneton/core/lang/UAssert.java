...
public class UAssert {
	...
	public static <X extends Throwable> void isTrue(boolean expression, Supplier<? extends X> supplier) throws X {
		notNull(supplier, "supplier must be not null");
		if (!expression) {
			throw supplier.get();
		}
	}
	 ...
	 * </pre>
	 * @param expression 布尔值
	 * @param errorMsgTemplate 错误抛出异常附带的消息模板，变量用{@code %s}代替
	 * @param params 参数列表
	 * @throws IllegalArgumentException if expression is {@code false}
	 */
	public static void isTrue(boolean expression, @Nullable String errorMsgTemplate, @Nullable Object... params)
			throws IllegalArgumentException {
		isTrue(expression, () -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	...
	public static <X extends Throwable> void isFalse(boolean expression, Supplier<X> errorSupplier) throws X {
		notNull(errorSupplier, "errorSupplier must be not null");
		if (expression) {
	 ...
	 * </pre>
	 * @param expression 布尔值
	 * @param errorMsgTemplate 错误抛出异常附带的消息模板，变量用%s代替
	 * @param params 参数列表
	 * @throws IllegalArgumentException if expression is {@code false}
	 */
	public static void isFalse(boolean expression, @Nullable String errorMsgTemplate, @Nullable Object... params)
			throws IllegalArgumentException {
		isFalse(expression, () -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	 ...
	 * </pre>
	 * @param object 被检查的对象
	 * @param errorMsgTemplate 消息模板，变量使用%s表示
	 * @param params 参数列表
	 * @throws IllegalArgumentException if the object is not {@code null}
	 */
	public static void isNull(Object object, @Nullable String errorMsgTemplate, @Nullable Object... params)
			throws IllegalArgumentException {
		isNull(object, () -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	 ...
	 * @param <T> 被检查对象泛型类型
	 * @param object 被检查对象
	 * @param errorMsgTemplate 错误消息模板，变量使用%s表示
	 * @param params 参数
	 * @return 被检查后的对象
	 * @throws IllegalArgumentException if the object is {@code null}
	 */
	public static <T> T notNull(T object, @Nullable String errorMsgTemplate, @Nullable Object... params)
			throws IllegalArgumentException {
		return notNull(object, () -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	 ...
	 */
	public static <T extends CharSequence> T notEmpty(T text, @Nullable String errorMsgTemplate,
			@Nullable Object... params) throws IllegalArgumentException {
		return notEmpty(text, () -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	...
	public static <T extends CharSequence, X extends Throwable> T notBlank(T text, Supplier<X> errorMsgSupplier)
			throws X {
		notNull(errorMsgSupplier, "errorMsgSupplier must be not null");
		if (UString.isBlank(text)) {
	 ...
	 */
	public static <T extends CharSequence> T notBlank(T text, @Nullable String errorMsgTemplate,
			@Nullable Object... params) throws IllegalArgumentException {
		return notBlank(text, () -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	 ...
	 * @throws X 非子串抛出异常
	 */
	public static <T extends CharSequence, X extends Throwable> T notContain(@Nullable CharSequence textToSearch,
			@Nullable T substring, Supplier<X> errorSupplier) throws X {
		notNull(errorSupplier, "errorSupplier must be not null");
		if (UString.contains(textToSearch, substring)) {
			throw errorSupplier.get();
		}
		return substring;
	}
	 ...
	 */
	public static String notContain(@Nullable String textToSearch, @Nullable String substring,
			@Nullable String errorMsgTemplate, @Nullable Object... params) throws IllegalArgumentException {
		return notContain(textToSearch, substring,
				() -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	 ...
	 */
	public static <T, X extends Throwable> T[] notEmpty(@Nullable T[] array, Supplier<X> errorSupplier) throws X {
		notNull(errorSupplier, "errorSupplier must be not null");
	 ...
	 * elements
	 */
	public static <T> T[] notEmpty(@Nullable T[] array, @Nullable String errorMsgTemplate, @Nullable Object... params)
			throws IllegalArgumentException {
		return notEmpty(array, () -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	 ...
	 * elements
	 */
	public static <T> T[] notEmpty(@Nullable T[] array) throws IllegalArgumentException {
	 ...
	 * @since 5.4.5
	 */
	public static <T, X extends Throwable> T[] noNullElements(@Nullable T[] array, Supplier<X> errorSupplier) throws X {
		notNull(errorSupplier, "errorSupplier must be not null");
		if (UArray.hasNull(array)) {
			throw errorSupplier.get();
		}
		return array;
	}
	 ...
	 * element
	 */
	public static <T> T[] noNullElements(@Nullable T[] array, @Nullable String errorMsgTemplate,
			@Nullable Object... params) throws IllegalArgumentException {
	 ...
	 * element
	 */
	public static <T> T[] noNullElements(@Nullable T[] array) throws IllegalArgumentException {
	...
	public static <K, V, T extends Map<K, V>> T notEmpty(T map, String errorMsgTemplate, Object... params)
			throws IllegalArgumentException {
		return notEmpty(map, () -> new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params)));
	}
	...
	public static <T> T isInstanceOf(Class<?> type, T obj, String errorMsgTemplate, Object... params)
		...
		if (false == type.isInstance(obj)) {
			throw new IllegalArgumentException(UString.lenientFormat(errorMsgTemplate, params));
		}
		return obj;
	}
	...
	public static void state(boolean expression, String errorMsgTemplate, Object... params)
		...
		if (false == expression) {
			throw new IllegalStateException(UString.lenientFormat(errorMsgTemplate, params));
		}
	}
	...
	public static Number checkBetween(Number value, Number min, Number max) {
		...
		if (valueDouble < minDouble || valueDouble > maxDouble) {
			throw new IllegalArgumentException(UString.lenientFormat(TEMPLATE_VALUE_MUST_BE_BETWEEN_AND, min, max));
		}
		return value;
	}
	...
	private static String badIndexMsg(int index, int size, String desc, Object... params) {
		if (index < 0) {
			return UString.lenientFormat("{} ({}) must not be negative", UString.lenientFormat(desc, params), index);
		}
		else if (size < 0) {
			throw new IllegalArgumentException("negative size: " + size);
		}
		else { // index >= size
			return UString.lenientFormat("{} ({}) must be less than size ({})", UString.lenientFormat(desc, params),
					index, size);
		}
	}
	// --------------------------------------------------------------------------------------------------------------------------------------------
