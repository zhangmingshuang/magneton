...
public final class UEnum {
	 ...
	 * If the constant does not exist, {@link Optional#absent} is returned. A common use
	 * case is for parsing user input or falling back to a default enum constant. For
	 * example, {@code
