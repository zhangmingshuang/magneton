...
/**
 * Wraps an event that was posted, but which had no subscribers and thus could not be
 * delivered.
 *
 * <p>
...
public class DeadEvent {
	 ...
	 * {@link org.magneton.core.eventbus.EventBus}).
	...
	/**
	 * Returns the wrapped, 'dead' event, which the system was unable to deliver to any
