...
/**
 * A class to allow {@link org.magneton.core.graph.Network} implementations to be backed
 * by a provided delegate. This is not currently planned to be released as a
...
abstract class ForwardingNetwork<N, E> extends AbstractNetwork<N, E> {
	...
	@Override
	public Set<E> edgesConnecting(org.magneton.core.graph.EndpointPair<N> endpoints) {
	...
	@Override
	public Optional<E> edgeConnecting(org.magneton.core.graph.EndpointPair<N> endpoints) {
	...
	@Override
	@CheckForNull
	public E edgeConnectingOrNull(org.magneton.core.graph.EndpointPair<N> endpoints) {
