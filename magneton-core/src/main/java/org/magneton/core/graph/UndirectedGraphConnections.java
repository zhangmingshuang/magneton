...
/**
 * An implementation of {@link org.magneton.core.graph.GraphConnections} for undirected
 * graphs.
 *
 * @author James Sexton
...
final class UndirectedGraphConnections<N, V> implements org.magneton.core.graph.GraphConnections<N, V> {
