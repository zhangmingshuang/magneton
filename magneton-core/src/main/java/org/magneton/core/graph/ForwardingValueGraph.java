...
/**
 * A class to allow {@link org.magneton.core.graph.ValueGraph} implementations to be
 * backed by a provided delegate. This is not currently planned to be released as a
...
abstract class ForwardingValueGraph<N, V> extends org.magneton.core.graph.AbstractValueGraph<N, V> {
	...
	/**
	 * Defer to {@link AbstractValueGraph#edges()} (based on {@link #successors(Object)})
