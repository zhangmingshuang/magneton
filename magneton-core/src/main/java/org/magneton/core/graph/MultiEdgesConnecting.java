 ...
 *
 * <p>
 * The {@link #outEdgeToNode} map allows this class to work on networks with parallel
 * edges. See {@link org.magneton.core.graph.EdgesConnecting} for a class that is more
 * efficient but forbids parallel edges.
 *
 * @author James Sexton
