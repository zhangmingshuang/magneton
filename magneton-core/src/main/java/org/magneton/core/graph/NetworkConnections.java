 ...
 * incident edges in a {@link Network}.
 *
 * @author James Sexton
...
interface NetworkConnections<N, E> {
	...
	/**
	 * Returns the set of edges connecting the origin node to {@code node}. For networks
	 * without parallel edges, this set cannot be of size greater than one.
	 */
	...
	/**
	 * Remove {@code edge} from the set of outgoing edges. Returns the former successor
	 * node.
	 */
	@CanIgnoreReturnValue
	...
	/**
	 * Add {@code edge} to the set of incoming edges. Implicitly adds {@code node} as a
	 * predecessor.
	 */
	void addInEdge(E edge, N node, boolean isSelfLoop);

	/**
	 * Add {@code edge} to the set of outgoing edges. Implicitly adds {@code node} as a
	 * successor.
	 */
