...
/**
 * Standard implementation of {@link ValueGraph} that supports the options supplied by
 * {@link org.magneton.core.graph.AbstractGraphBuilder}.
 *
 * <p>
...
class StandardValueGraph<N, V> extends AbstractValueGraph<N, V> {
	...
	StandardValueGraph(org.magneton.core.graph.AbstractGraphBuilder<? super N> builder) {
	...
	public Set<org.magneton.core.graph.EndpointPair<N>> incidentEdges(N node) {
		...
		return new org.magneton.core.graph.IncidentEdgeSet<N>(this, node) {
			@Override
			public Iterator<org.magneton.core.graph.EndpointPair<N>> iterator() {
