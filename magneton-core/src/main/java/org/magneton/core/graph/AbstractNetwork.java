...
import static org.magneton.core.graph.GraphConstants.MULTIPLE_EDGES_CONNECTING;

/**
 * This class provides a skeletal implementation of
 * {@link org.magneton.core.graph.Network}. It is recommended to extend this class rather
 * than implement {@link org.magneton.core.graph.Network} directly.
 *
 * <p>
...
public abstract class AbstractNetwork<N, E> implements org.magneton.core.graph.Network<N, E> {
		...
		return new AbstractGraph<N>() {
			...
			public Set<EndpointPair<N>> edges() {
				...
				return new AbstractSet<EndpointPair<N>>() {
					...
					// we perform unsafe
					// operations only in weird cases like checking for an
					// EndpointPair<ArrayList> in a
					// Network<LinkedList>.
					@Override
			...
			public ElementOrder<N> incidentEdgeOrder() {
				// TODO(b/142723300): Return AbstractNetwork.this.incidentEdgeOrder() once
				// Network has that
				// method.
	...
	public Set<E> edgesConnecting(N nodeU, N nodeV) {
		...
		return outEdgesU.size() <= inEdgesV.size()
				? unmodifiableSet(org.magneton.core.collect.Sets.filter(outEdgesU, connectedPredicate(nodeU, nodeV)))
	...
	/**
	 * Throws an IllegalArgumentException if the ordering of {@code endpoints} is not
	...
	public final boolean equals(@CheckForNull Object obj) {
		...
		if (!(obj instanceof org.magneton.core.graph.Network)) {
			return false;
		}
		org.magneton.core.graph.Network<?, ?> other = (org.magneton.core.graph.Network<?, ?>) obj;
	...
	public String toString() {
		return "isDirected: " + isDirected() + ", allowsParallelEdges: " + allowsParallelEdges() + ", allowsSelfLoops: "
				+ allowsSelfLoops() + ", nodes: " + nodes() + ", edges: " + edgeIncidentNodesMap(this);
	}
