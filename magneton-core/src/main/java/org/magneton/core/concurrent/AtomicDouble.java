 ...
 * atomic accumulation, and cannot be used as a replacement for a {@link Double}. However,
 * this class does extend {@code
 * Number} to allow uniform access by tools and utilities that deal with numerically-based
 * classes.
 *
 * <p>
 ...
 *
 * <p>
 * It is possible to write a more scalable updater, at the cost of giving up strict
 * atomicity. See for example <a href=
 * "http://gee.cs.oswego.edu/dl/jsr166/dist/docs/java.base/java/util/concurrent/atomic/DoubleAdder.html">
 * DoubleAdder</a>.
 *
 * @author Doug Lea
...
public class AtomicDouble extends Number implements java.io.Serializable {
	 ...
	 * was not bitwise equal to the expected value.
	 */
	...
	/**
	 * Returns the value of this {@code AtomicDouble} as an {@code int} after a narrowing
	...
	/**
	 * Returns the value of this {@code AtomicDouble} as a {@code long} after a narrowing
	 * primitive conversion.
	 */
	@Override
	...
	/**
	 * Returns the value of this {@code AtomicDouble} as a {@code float} after a narrowing
	 * primitive conversion.
	 */
	@Override
