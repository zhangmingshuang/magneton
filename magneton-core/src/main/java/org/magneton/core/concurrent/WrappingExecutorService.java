 ...
 * {@linkplain #wrapTask(Callable) wrap} tasks before they are submitted to the underlying
 * executor.
 *
 * <p>
 ...
 *
 * <p>
 * For delegation without task-wrapping, see {@link ForwardingExecutorService}.
 *
...
abstract class WrappingExecutorService implements ExecutorService {
	 ...
	 * also applied to any {@code Runnable} passed to the default implementation of
	 * {@link #wrapTask(Runnable)}.
	 */
	...
	public final <T> Future<T> submit(Callable<T> task) {
		return this.delegate.submit(this.wrapTask(checkNotNull(task)));
	}
