...
/**
 * Static utility methods pertaining to classes in the {@code java.util.concurrent.atomic}
 * package.
 *
...
public final class Atomics {
	 ...
	 */
	public static <V extends Object> AtomicReference<V> newReference(@ParametricNullness V initialValue) {
	...
	/**
	 * Creates an {@code AtomicReferenceArray} instance with the same length as, and all
