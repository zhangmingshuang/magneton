...
/**
 * A {@link ListenableFuture} which forwards all its method calls to another future.
 * Subclasses should override one or more methods to modify the behavior of the backing
 * future as desired per the
...
public abstract class ForwardingListenableFuture<V extends Object> extends ForwardingFuture<V>
	 ...
	 * pass in an already constructed {@link ListenableFuture} as the delegate.
	 *
	 * @since 9.0
	 */
