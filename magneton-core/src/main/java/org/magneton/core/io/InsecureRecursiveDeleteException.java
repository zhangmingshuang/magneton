 ...
 * conditions that would allow it to delete files and directories outside of the directory
 * being deleted (i.e., {@link SecureDirectoryStream} is not supported).
 *
 * <p>
 * {@link RecursiveDeleteOption#ALLOW_INSECURE} can be used to force the recursive delete
 * method to proceed anyway.
 *
 * @since 21.0
 * @author Colin Decker
 */
