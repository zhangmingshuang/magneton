 ...
 * {@link LineReader}. Line separators are per {@link java.io.BufferedReader}: line feed,
 * carriage return, or carriage return followed immediately by a linefeed.
 *
 * <p>
 * Subclasses must implement {@link #handleLine}, call {@link #add} to pass character
 * data, and call {@link #finish} at the end of stream.
 *
...
abstract class LineBuffer {
	...
	/**
	 * Process additional characters from the stream. When a line separator is found the
	 * contents of the line and the line separator itself are passed to the abstract
	 * {@link #handleLine} method.
	...
	/**
	 * Subclasses must call this method after finishing character processing, in order to
	 * ensure that any unterminated line in the buffer is passed to {@link #handleLine}.
	 * @throws IOException if an I/O error occurs
	 */
