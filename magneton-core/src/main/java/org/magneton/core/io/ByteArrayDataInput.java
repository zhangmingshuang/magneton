 ...
 *
 * <p>
 * <b>Warning:</b> The caller is responsible for not attempting to read past the end of
 * the array. If any method encounters the end of the array prematurely, it throws
 * {@link IllegalStateException} to signify <i>programmer error</i>. This behavior is a
 * technical violation of the supertype's contract, which specifies a checked exception.
 *
