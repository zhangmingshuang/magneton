...
/**
 * Writer that places all output on an {@link Appendable} target. If the target is
 * {@link Flushable} or {@link Closeable}, flush()es and close()s will also be delegated
 * to the target.
 *
 * @author Alan Green
...
class AppendableWriter extends Writer {
	...
	/*
	 * Override a few functions for performance reasons to avoid creating unnecessary
	 * strings.
	 */
