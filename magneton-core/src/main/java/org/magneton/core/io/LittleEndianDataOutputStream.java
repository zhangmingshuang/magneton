...
/**
 * An implementation of {@link DataOutput} that uses little-endian byte ordering for
 * writing {@code
 * char}, {@code short}, {@code int}, {@code float}, {@code double}, and {@code long}
 * values.
 *
 * <p>
...
public final class LittleEndianDataOutputStream extends FilterOutputStream implements DataOutput {
	...
	/**
	 * @deprecated The semantics of {@code writeBytes(String s)} are considered dangerous.
	 * Please use {@link #writeUTF(String s)}, {@link #writeChars(String s)} or another
	 ...
	 * {@link DataOutputStream#writeChars(String)}, except each character is written using
	 * little-endian byte order.
	 * @throws IOException if an I/O error occurs
	 */
	@Override
	...
	/**
	 * Writes a {@code float} as specified by {@link DataOutputStream#writeFloat(float)},
	...
	/**
	 * Writes a {@code long} as specified by {@link DataOutputStream#writeLong(long)},
	 * except using little-endian byte order.
	 * @throws IOException if an I/O error occurs
	 */
	@Override
	...
	/**
	 * Writes a {@code short} as specified by {@link DataOutputStream#writeShort(int)},
	 * except using little-endian byte order.
	 * @throws IOException if an I/O error occurs
	 */
	@Override
