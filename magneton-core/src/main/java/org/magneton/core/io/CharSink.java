 ...
 * {@link Writer}, a {@code CharSink} is not an open, stateful stream that can be written
 * to and closed. Instead, it is an immutable <i>supplier</i> of {@code Writer} instances.
 *
 * <p>
 ...
 * that the returned writer is closed.
 * <li><b>Convenience methods:</b> These are implementations of common operations that are
 * typically implemented by opening a writer using one of the methods in the first
 * category, doing something and finally closing the writer that was opened.
 * </ul>
 *
 * <p>
 * Any {@link org.magneton.core.io.ByteSink} may be viewed as a {@code CharSink} with a
 * specific {@linkplain Charset character encoding} using
...
public abstract class CharSink {
	...
	/**
	 * Opens a new {@link Writer} for writing to this sink. This method returns a new,
	...
	/**
	 * Opens a new buffered {@link Writer} for writing to this sink. The returned stream
	 * is not required to be a {@link BufferedWriter} in order to allow implementations to
	 * simply delegate to {@link #openStream()} when the stream returned by that method
	 * does not benefit from additional buffering. This method returns a new, independent
	...
	/**
	 * Writes the given lines of text to this sink with each line (including the last)
	 * terminated with the operating system's default line separator. This method is
	 * equivalent to {@code
	...
	/**
	 * Writes the given lines of text to this sink with each line (including the last)
	 * terminated with the given line separator.
	 * @throws IOException if an I/O error occurs while writing to this sink
	 */
	...
	/**
	 * Writes all the text from the given {@link Readable} (such as a {@link Reader}) to
	 * this sink. Does not close {@code readable} if it is {@code Closeable}.
	 * @return the number of characters written
	 * @throws IOException if an I/O error occurs while reading from {@code readable} or
