...
/**
 * Provides utility methods for working with resources in the classpath. Note that even
 * though these methods use {@link URL} parameters, they are usually not appropriate for
 * HTTP or other non-classpath resources.
 *
...
public final class Resources {
	 ...
	 * {@link org.magneton.core.base.Charsets} for helpful predefined constants
	...
	/**
	 * Streams lines from a URL, stopping when our callback returns false, or we have read
	 * all of the lines.
	 * @param url the URL to read from
	 * @param charset the charset used to decode the input stream; see
	 * {@link org.magneton.core.base.Charsets} for helpful predefined constants
	 ...
	 * @param url the URL to read from
	 * @param charset the charset used to decode the input stream; see {@link Charsets}
	...
	/**
	 * Returns a {@code URL} pointing to {@code resourceName} if the resource is found
	 * using the {@linkplain Thread#getContextClassLoader() context class loader}. In
	 * simple environments, the context class loader will find resources from the class
	 * path. In environments where different threads can have different class loaders, for
	 * example app servers, the context class loader will typically have been set to an
	 * appropriate loader for the current thread.
	 *
	 * <p>
	 * In the unusual case where the context class loader is null, the class loader that
	 * loaded this class ({@code Resources}) will be used instead.
	...
	/**
	 * Given a {@code resourceName} that is relative to {@code contextClass}, returns a
	 * {@code URL} pointing to the named resource.
	 * @throws IllegalArgumentException if the resource is not found
	 */
	@CanIgnoreReturnValue // being used to check if a resource exists
	public static URL getResource(Class<?> contextClass, String resourceName) {
		URL url = contextClass.getResource(resourceName);
		Preconditions.checkArgument(url != null, "resource %s relative to %s not found.", resourceName,
