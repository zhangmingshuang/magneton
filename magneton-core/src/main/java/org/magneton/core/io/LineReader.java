 ...
 * {@link java.io.BufferedReader#readLine()} but for all {@link Readable} objects, not
 * just instances of {@link Reader}.
 *
...
public final class LineReader {
	...
	private final org.magneton.core.io.LineBuffer lineBuf = new org.magneton.core.io.LineBuffer() {
		@Override
	 ...
	 * feed ({@code
	 * '\n'}), a carriage return ({@code '\r'}), or a carriage return followed immediately
	 * by a linefeed ({@code "\r\n"}).
