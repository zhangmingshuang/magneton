...
/**
 * Static utility methods pertaining to {@code boolean} primitives, that are not already
 * found in either {@link Boolean} or {@link Arrays}.
 *
 * <p>
...
public final class Booleans {
	 ...
	 * {@code Comparators.comparing}, e.g.
	 * {@code Comparators.comparing(Foo::hasBar, trueFirst())}.
	 *
	 * @since 21.0
	 */
	 ...
	 * This is particularly useful in Java 8+ in combination with
	 * {@code Comparators.comparing}, e.g.
	 * {@code Comparators.comparing(Foo::hasBar, falseFirst())}.
	 *
	 * @since 21.0
	 */
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Boolean#hashCode(boolean)} instead.
	 ...
	 * the equivalent {@link Boolean#compare} method instead.
	 * @param a the first {@code boolean} to compare
	 * @param b the second {@code boolean} to compare
	 * @return a positive number if only {@code a} is {@code true}, a negative number if
	 * only {@code
	 ...
	 *
	 * <p>
	 * <b>Note:</b> consider representing the array as a {@link java.util.BitSet} instead,
	 * replacing {@code Booleans.contains(array, true)} with {@code !bitSet.isEmpty()} and
	 * {@code
	 * Booleans.contains(array, false)} with
	 ...
	 * <p>
	 * <b>Note:</b> consider representing the array as a {@link java.util.BitSet} instead,
	 * and using {@link java.util.BitSet#nextSetBit(int)} or
	 ...
	 * example, {@code concat(new boolean[] {a, b}, new boolean[] {}, new boolean[] {c}}
	 ...
	 * {@code separator}. For example, {@code join("-", false, true, false)} returns the
	 * string {@code
	 * "false-true-false"}.
	 ...
	 * That is, it compares, using {@link #compare(boolean, boolean)}), the first pair of
	...
	/**
	 * Copies a collection of {@code Boolean} instances into a new array of primitive
	 * {@code boolean} values.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * <b>Note:</b> consider representing the collection as a {@link java.util.BitSet}
	 * instead.
	 ...
	 *
	 * <p>
	 * The returned list maintains the values, but not the identities, of {@code Boolean}
	 ...
	 * Collections.reverse(Booleans.asList(array).subList(fromIndex, toIndex))}, but is
	...
	private enum BooleanComparator implements Comparator<Boolean> {
		...
		TRUE_FIRST(1, "Booleans.trueFirst()"), FALSE_FIRST(-1, "Booleans.falseFirst()");
