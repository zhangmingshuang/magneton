 ...
 * {@code
 * 2^32 + x}). The methods for which signedness is not an issue are in {@link Ints}, as
 * well as signed versions of methods for which signedness is an issue.
 *
 * <p>
 * In addition, this class provides several static methods for converting an {@code int}
 * to a {@code String} and a {@code String} to an {@code int} that treat the {@code int}
 * as an unsigned number.
 *
 * <p>
 * Users of these utilities must be <i>extremely careful</i> not to mix up signed and
 * unsigned {@code int} values. When possible, it is recommended that the
 * {@link UnsignedInteger} wrapper class be used, at a small efficiency penalty, to
 * enforce the distinction in the type system.
 *
 * <p>
...
public final class UnsignedInts {
	...
	/**
	 * Compares the two specified {@code int} values, treating them as unsigned values
	 * between {@code
	 * 0} and {@code 2^32 - 1} inclusive.
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Integer#compareUnsigned(int, int)} instead.
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Integer#toUnsignedLong(int)} instead.
	 */
	...
	/**
	 * Returns the {@code int} value that, when treated as unsigned, is equal to
	 ...
	 * @throws IllegalArgumentException if {@code value} is negative or greater than or
	 * equal to 2<sup>32</sup>
	 * @since 21.0
	 */
	...
	/**
	 * Returns the {@code int} value that, when treated as unsigned, is nearest in value
	 * to {@code
	 * value}.
	 * @param value any {@code long} value
	 * @return {@code 2^32 - 1} if {@code value >= 2^32}, {@code 0} if {@code value <= 0},
	 * and {@code
	 ...
	 * treating its elements as unsigned 32-bit integers.
	 *
	 * @since 23.1
	 */
	 ...
	 * {@code toIndex} exclusive in descending order, interpreting them as unsigned 32-bit
	 * integers.
	 *
	 * @since 23.1
	 */
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Integer#divideUnsigned(int, int)} instead.
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Integer#remainderUnsigned(int, int)} instead.
	 * @param dividend the dividend (numerator)
	 * @param divisor the divisor (denominator)
	 * @throws ArithmeticException if divisor is 0
	 */
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Integer#parseUnsignedInt(String)} instead.
	 * @throws NumberFormatException if the string does not contain a valid unsigned
	 * {@code int} value
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Integer#parseUnsignedInt(String, int)} instead.
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Integer#toUnsignedString(int)} instead.
	 */
