...
/**
 * Static utility methods pertaining to {@code byte} primitives, that are not already
 * found in either {@link Byte} or {@link Arrays}, <i>and interpret bytes as neither
 * signed nor unsigned</i>. The methods which specifically treat bytes as signed or
 * unsigned are found in {@link SignedBytes} and {@link UnsignedBytes}.
 *
 * <p>
...
public final class Bytes {
	 ...
	 * example, {@code concat(new byte[] {a, b}, new byte[] {}, new byte[] {c}} returns
