...
/**
 * Static utility methods pertaining to {@code short} primitives, that are not already
 * found in either {@link Short} or {@link Arrays}.
 *
 * <p>
...
public final class Shorts extends ShortsMethodsForWeb {
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Short#BYTES} instead.
	 */
	 ...
	 *
	 * <p>
	 * <b>Java 8 users:</b> use {@link Short#hashCode(short)} instead.
	 ...
	 * {@link Short#MAX_VALUE} or less than {@link Short#MIN_VALUE}
	 */
	...
	/**
	 * Compares the two specified {@code short} values. The sign of the value returned is
	 * the same as that of {@code ((Short) a).compareTo(b)}.
	 *
	 * <p>
	 * <b>Note for Java 7 and later:</b> this method should be treated as deprecated; use
	 * the equivalent {@link Short#compare} method instead.
	 ...
	 * example, {@code concat(new short[] {a, b}, new short[] {}, new short[] {c}} returns
	 ...
	 * equivalent to {@code ByteBuffer.allocate(2).putShort(value).array()}. For example,
	...
	/**
	 * Returns the {@code short} value whose big-endian representation is stored in the
	 * first 2 bytes of {@code bytes}; equivalent to
	 * {@code ByteBuffer.wrap(bytes).getShort()}. For example, the input byte array
	...
	/**
	 * Returns the {@code short} value whose byte representation is the given 2 bytes, in
	 * big-endian order; equivalent to {@code Shorts.fromByteArray(new byte[] {b1, b2})}.
	 *
	 * @since 7.0
	 */
	...
	/**
	 * Returns a serializable converter object that converts between strings and shorts
	 * using {@link Short#decode} and {@link Short#toString()}. The returned converter
	 * throws {@link NumberFormatException} if the input string is invalid.
	 *
	 * <p>
	 * <b>Warning:</b> please see {@link Short#decode} to understand exactly how strings
	 ...
	 * {@code separator}. For example, {@code join("-", (short) 1, (short) 2, (short) 3)}
	 ...
	 * That is, it compares, using {@link #compare(short, short)}), the first pair of
	 ...
	 * {@code [] < [(short) 1] < [(short) 1, (short) 2] < [(short) 2]}.
	 *
	 * <p>
	 ...
	 * Collections.reverse(Shorts.asList(array).subList(fromIndex, toIndex))}, but is
	 ...
	 *
	 * <p>
	 * The returned list maintains the values, but not the identities, of {@code Short}
	...
	private static final class ShortConverter extends org.magneton.core.base.Converter<String, Short>
