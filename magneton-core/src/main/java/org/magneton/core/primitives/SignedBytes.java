 ...
 * signed. The corresponding methods that treat the values as unsigned are found in
 * {@link UnsignedBytes}, and the methods for which signedness is not an issue are in
 * {@link Bytes}.
 *
 * <p>
...
public final class SignedBytes {
	 ...
	 * {@link Byte#MAX_VALUE} or less than {@link Byte#MIN_VALUE}
	 */
	...
	/**
	 * Compares the two specified {@code byte} values. The sign of the value returned is
	 * the same as that of {@code ((Byte) a).compareTo(b)}.
	 *
	 * <p>
	 ...
	 * {@code separator}. For example, {@code join(":", 0x01, 0x02, -0x01)} returns the
	 * string {@code "1:2:-1"}.
	 ...
	 * {@code [] < [0x01] < [0x01, 0x80] < [0x01, 0x7F] < [0x02]}. Values are treated as
	 * signed.
	 *
	 * <p>
