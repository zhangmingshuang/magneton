...
import org.magneton.core.cache.LocalCache.Strength;
...
import static org.magneton.core.base.Strings.isNullOrEmpty;

/**
 * A specification of a {@link org.magneton.core.cache.CacheBuilder} configuration.
 *
 * <p>
 ...
 *
 * <p>
 * The string syntax is a series of comma-separated keys or key-value pairs, each
 * corresponding to a {@code CacheBuilder} method.
 *
 * <ul>
 * <li>{@code concurrencyLevel=[integer]}: sets
 * {@link org.magneton.core.cache.CacheBuilder#concurrencyLevel}.
 * <li>{@code initialCapacity=[integer]}: sets
 * {@link org.magneton.core.cache.CacheBuilder#initialCapacity}.
 * <li>{@code maximumSize=[long]}: sets
 * {@link org.magneton.core.cache.CacheBuilder#maximumSize}.
 * <li>{@code maximumWeight=[long]}: sets
 * {@link org.magneton.core.cache.CacheBuilder#maximumWeight}.
 * <li>{@code expireAfterAccess=[duration]}: sets
 * {@link org.magneton.core.cache.CacheBuilder#expireAfterAccess}.
 * <li>{@code expireAfterWrite=[duration]}: sets
 * {@link org.magneton.core.cache.CacheBuilder#expireAfterWrite}.
 * <li>{@code refreshAfterWrite=[duration]}: sets
 * {@link org.magneton.core.cache.CacheBuilder#refreshAfterWrite}.
 * <li>{@code weakKeys}: sets {@link org.magneton.core.cache.CacheBuilder#weakKeys}.
 * <li>{@code softValues}: sets {@link org.magneton.core.cache.CacheBuilder#softValues}.
 * <li>{@code weakValues}: sets {@link org.magneton.core.cache.CacheBuilder#weakValues}.
 * <li>{@code recordStats}: sets {@link org.magneton.core.cache.CacheBuilder#recordStats}.
 * </ul>
 *
 * <p>
 ...
 *
 * <p>
 * Whitespace before and after commas and equal signs is ignored. Keys may not be
 * repeated; it is also illegal to use the following pairs of keys in a single value:
 *
 * <ul>
 ...
 *
 * <p>
 * A new {@code CacheBuilder} can be instantiated from a {@code CacheBuilderSpec} using
 * {@link org.magneton.core.cache.CacheBuilder#from(CacheBuilderSpec)} or
 * {@link org.magneton.core.cache.CacheBuilder#from(String)}.
 *
 * @author Adam Winer
 * @since 12.0
 */
// lots of violations (nanosecond math)
...
public final class CacheBuilderSpec {
	...
	/**
	 * Converts an expiration duration/unit pair into a single Long for hashing and
	 * equality. Uses nanos to match CacheBuilder implementation.
	 */
	@CheckForNull
	...
	org.magneton.core.cache.CacheBuilder<Object, Object> toCacheBuilder() {
		org.magneton.core.cache.CacheBuilder<Object, Object> builder = CacheBuilder.newBuilder();
	...
	/**
	 * Returns a string that can be used to parse an equivalent {@code CacheBuilderSpec}.
	 * The order and form of this representation is not guaranteed, except that reparsing
	 * its output will produce a {@code CacheBuilderSpec} equal to this instance.
	 */
	...
	/**
	 * Returns a string representation for this CacheBuilderSpec instance. The form of
	 * this representation is not guaranteed.
	 */
	@Override
