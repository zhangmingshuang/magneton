...
import org.magneton.core.cache.LocalCache.ValueReference;
...
interface ReferenceEntry<K, V> {
	 ...
	 * doubly-linked list. New entries are added at the tail of the list at write time;
	 ...
	 * doubly-linked list. New entries are added at the tail of the list at write time and
	 * stale entries are expired from the head of the list.
	 */
