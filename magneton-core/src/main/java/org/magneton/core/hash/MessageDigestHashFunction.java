...
final class MessageDigestHashFunction extends org.magneton.core.hash.AbstractHashFunction implements Serializable {
	...
	private static final class MessageDigestHasher extends org.magneton.core.hash.AbstractByteHasher {
		...
		public org.magneton.core.hash.HashCode hash() {
			...
			return (bytes == digest.getDigestLength())
					? org.magneton.core.hash.HashCode.fromBytesNoCopy(digest.digest())
