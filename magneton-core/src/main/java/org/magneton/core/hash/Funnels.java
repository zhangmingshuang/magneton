...
public final class Funnels {
	 ...
	 * character at a time, without performing any encoding. If you need to use a specific
	 * encoding, use {@link Funnels#stringFunnel(Charset)} instead.
	 *
	...
	/**
	 * Returns a funnel that encodes the characters of a {@code CharSequence} with the
	...
	/**
	 * Returns a funnel that processes an {@code Iterable} by funneling its elements in
	 * iteration order with the specified funnel. No separators are added between the
	 * elements.
	 *
	 * @since 15.0
	 */
	public static <E extends Object> Funnel<Iterable<? extends E>> sequentialFunnel(Funnel<E> elementFunnel) {
	 ...
	 *
	 * <p>
	 * The {@code close} and {@code flush} methods of the returned {@code OutputStream} do
	 * nothing, and no method throws {@code IOException}.
	 *
	 * @since 13.0
	 */
	...
	private static class StringCharsetFunnel implements Funnel<CharSequence>, Serializable {
		...
		public boolean equals(@CheckForNull Object o) {
			if (o instanceof StringCharsetFunnel) {
				...
				return charset.equals(funnel.charset);
			}
			return false;
		}
	...
	private static class SequentialFunnel<E extends Object> implements Funnel<Iterable<? extends E>>, Serializable {
