...
public final class HashingInputStream extends FilterInputStream {
	 ...
	 * {@link org.magneton.core.hash.HashFunction} and delegates all data read from it to
	...
	/**
	 * Reads the next byte of data from the underlying input stream and updates the hasher
	 * with the byte read.
	 */
	@Override
	...
	/**
	 * Reads the specified bytes of data from the underlying input stream and updates the
	 * hasher with the bytes read.
	 */
	@Override
	@CanIgnoreReturnValue
	...
	/**
	 * Returns the {@link org.magneton.core.hash.HashCode} based on the data read from
