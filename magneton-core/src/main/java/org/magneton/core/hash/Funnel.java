 ...
 * serialization of funnels. When possible, it is recommended that funnels be implemented
 * as a single-element enum to maintain serialization guarantees. See Effective Java (2nd
 * Edition), Item 3: "Enforce the singleton property with a private constructor or an enum
 * type". For example:
 *
 * <pre>{@code
...
public interface Funnel<T> extends Serializable {
	 ...
	 * There is no requirement that this data be complete enough to fully reconstitute the
	 * object later.
	 *
