...
/**
 * See MurmurHash3_x64_128 in
 * <a href="http://smhasher.googlecode.com/svn/trunk/MurmurHash3.cpp">the C++
 * implementation</a>.
 *
...
final class Murmur3_128HashFunction extends org.magneton.core.hash.AbstractHashFunction implements Serializable {

	static final org.magneton.core.hash.HashFunction MURMUR3_128 = new Murmur3_128HashFunction(0);
	...
	private static final class Murmur3_128Hasher extends org.magneton.core.hash.AbstractStreamingHasher {
		...
		@Override
		protected org.magneton.core.hash.HashCode makeHash() {
			h1 ^= length;
			h2 ^= length;
