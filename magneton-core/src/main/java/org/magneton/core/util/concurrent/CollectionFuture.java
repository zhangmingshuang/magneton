...
abstract class CollectionFuture<V extends Object, C extends Object>
		extends org.magneton.core.util.concurrent.AggregateFuture<V, C> {
	...
	CollectionFuture(
			ImmutableCollection<? extends org.magneton.core.util.concurrent.ListenableFuture<? extends V>> futures,
	...
	/**
	 * Used for {@link org.magneton.core.util.concurrent.Futures#allAsList} and
