...
abstract class WrappingScheduledExecutorService extends org.magneton.core.util.concurrent.WrappingExecutorService
	...
	@Override
	public final <V extends Object> ScheduledFuture<V> schedule(Callable<V> task, long delay, TimeUnit unit) {
