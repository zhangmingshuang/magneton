...
import org.magneton.core.collect.ForwardingQueue;

/**
 * A {@link BlockingQueue} which forwards all its method calls to another
 * {@link BlockingQueue}. Subclasses should override one or more methods to modify the
 * behavior of the backing collection as desired per the
