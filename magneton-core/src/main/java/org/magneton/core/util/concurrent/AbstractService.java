...
import org.magneton.core.util.concurrent.Monitor.Guard;
...
public abstract class AbstractService implements Service {
	...
	private static final org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> STARTING_EVENT = new org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener>() {
		@Override
	...
	private static final org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> RUNNING_EVENT = new org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener>() {
		@Override
		public void call(Listener listener) {
			listener.running();
		}
	...
	private static final org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> STOPPING_FROM_STARTING_EVENT = stoppingEvent(
			STARTING);

	private static final org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> STOPPING_FROM_RUNNING_EVENT = stoppingEvent(
			RUNNING);

	private static final org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> TERMINATED_FROM_NEW_EVENT = terminatedEvent(
			NEW);

	private static final org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> TERMINATED_FROM_STARTING_EVENT = terminatedEvent(
			STARTING);

	private static final org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> TERMINATED_FROM_RUNNING_EVENT = terminatedEvent(
			RUNNING);

	private static final org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> TERMINATED_FROM_STOPPING_EVENT = terminatedEvent(
			STOPPING);

	private final org.magneton.core.util.concurrent.Monitor monitor = new Monitor();
	...
	private final org.magneton.core.util.concurrent.ListenerCallQueue<Listener> listeners = new org.magneton.core.util.concurrent.ListenerCallQueue<>();
	...
	private static org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> terminatedEvent(State from) {
		return new org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener>() {
			@Override
			public void call(Listener listener) {
	...
	private static org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener> stoppingEvent(State from) {
		return new org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener>() {
			@Override
			public void call(Listener listener) {
	...
	public final void awaitTerminated(Duration timeout) throws TimeoutException {
		org.magneton.core.util.concurrent.Service.super.awaitTerminated(timeout);
	}
		...
		if (actual != expected) {
			if (actual == FAILED) {
				...
				throw new IllegalStateException(
						"Expected the service " + this + " to be " + expected + ", but the service has FAILED", failureCause());
			}
			throw new IllegalStateException(
	...
	private void enqueueFailedEvent(State from, Throwable cause) {
		...
		listeners.enqueue(new org.magneton.core.util.concurrent.ListenerCallQueue.Event<Listener>() {
			@Override
			public void call(Listener listener) {
	...
	private static final class StateSnapshot {
		...
		/** @see org.magneton.core.util.concurrent.Service#state() */
		State externalState() {
