...
import static org.magneton.core.base.Verify.verify;
import static org.magneton.core.util.concurrent.Internal.toNanosSaturated;

/**
 * Utilities for treating interruptible operations as uninterruptible. In all cases, if a
 * thread is interrupted during such a call, the call continues to block until the result
 * is available or the timeout elapses, and only then re-interrupts the thread.
 *
 * @author Anthony Zana
 * @since 10.0
 */
...
public final class Uninterruptibles {
	...
	/**
	 * Invokes {@code latch.}{@link CountDownLatch#await(long, TimeUnit) await(timeout,
	 * unit)} uninterruptibly.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * Invokes {@code condition.}{@link Condition#await(long, TimeUnit) await(timeout,
	 * unit)} uninterruptibly.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * Invokes {@code unit.}{@link TimeUnit#timedJoin(Thread, long) timedJoin(toJoin,
	 ...
	 * {@link org.magneton.core.util.concurrent.Futures#getDone Futures.getDone}.
	 ...
	 * Futures.getChecked}.
	 * <li>To get uninterruptibility and remove checked exceptions, use
	 * {@link org.magneton.core.util.concurrent.Futures#getUnchecked}.
	 * </ul>
	...
	@ParametricNullness
	public static <V extends Object> V getUninterruptibly(Future<V> future) throws ExecutionException {
		boolean interrupted = false;
		try {
			while (true) {
				try {
	...
	/**
	 * Invokes {@code future.}{@link Future#get(long, TimeUnit) get(timeout, unit)}
	 * uninterruptibly.
	 *
	 * <p>
	 * Similar methods:
	 ...
	 * {@link org.magneton.core.util.concurrent.Futures#getDone Futures.getDone}.
	 * <li>To treat {@link InterruptedException} uniformly with other exceptions, use
	 * {@link org.magneton.core.util.concurrent.Futures#getChecked(Future, Class, long, TimeUnit)
	 * Futures.getChecked}.
	 * <li>To get uninterruptibility and remove checked exceptions, use
	 * {@link org.magneton.core.util.concurrent.Futures#getUnchecked}.
	 * </ul>
	...
	// should accept a java.time.Duration
	@ParametricNullness
	public static <V extends Object> V getUninterruptibly(Future<V> future, long timeout, TimeUnit unit)
			throws ExecutionException, TimeoutException {
		boolean interrupted = false;
		try {
			long remainingNanos = unit.toNanos(timeout);
