...
/**
 * {@link org.magneton.core.util.concurrent.FluentFuture} that forwards all calls to a
 * delegate.
 *
 * <h3>Extension</h3>
 *
 * If you want a class like {@code FluentFuture} but with extra methods, we recommend
 * declaring your own subclass of
 * {@link org.magneton.core.util.concurrent.ListenableFuture}, complete with a method like
