...
public abstract class AbstractIdleService implements org.magneton.core.util.concurrent.Service {
	...
	private final org.magneton.core.util.concurrent.Service delegate = new DelegateService();
	...
	private final class DelegateService extends AbstractService {
		...
		protected final void doStart() {
			org.magneton.core.util.concurrent.MoreExecutors.renamingDecorator(executor(), threadNameSupplier)
