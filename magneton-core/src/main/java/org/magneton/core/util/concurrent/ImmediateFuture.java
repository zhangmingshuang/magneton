...
import org.magneton.core.util.concurrent.AbstractFuture.TrustedFuture;
...
class ImmediateFuture<V extends Object> implements org.magneton.core.util.concurrent.ListenableFuture<V> {
	...
	public void addListener(Runnable listener, Executor executor) {
		...
		try {
			...
			// ListenableFuture's contract is that it will not throw unchecked exceptions,
			// so log the bad
