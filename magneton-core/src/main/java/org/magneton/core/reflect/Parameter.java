 ...
 *
 * <p>
 * <b>Note:</b> Since Java 8 introduced {@link java.lang.reflect.Parameter} to represent
 * method and constructor parameters, this class is no longer necessary. We intend to
 * deprecate it in a future version.
 *
 * @author Ben Yu
 * @since 14.0
 */
...
public final class Parameter implements AnnotatedElement {
	...
	private final org.magneton.core.reflect.Invokable<?, ?> declaration;
	...
	Parameter(org.magneton.core.reflect.Invokable<?, ?> declaration, int position, TypeToken<?> type,
			Annotation[] annotations, AnnotatedType annotatedType) {
	...
	/**
	 * Returns the {@link org.magneton.core.reflect.Invokable} that declares this
	 * parameter.
	 */
