 ...
 * {@link Object#equals}, {@link Object#hashCode} and {@link Object#toString}. For
 * example:
 *
 * <pre>
...
public abstract class AbstractInvocationHandler implements InvocationHandler {
	...
	private static boolean isProxyOfSameInterfaces(Object arg, Class<?> proxyClass) {
		return proxyClass.isInstance(arg)
				...
				// Under some edge cases (such as the proxy of JDK types serialized and
				// then deserialized)
	 ...
	 * {@link AbstractInvocationHandler#hashCode}
	 * <li>{@code proxy.toString()} delegates to
	 * {@link AbstractInvocationHandler#toString}
	...
	/**
	 * {@link #invoke} delegates to this method upon any method invocation on the proxy
	 * instance, except {@link Object#equals}, {@link Object#hashCode} and
	 * {@link Object#toString}. The result will be returned as the proxied method's return
	 * value.
	 *
	 * <p>
	 * Unlike {@link #invoke}, {@code args} will never be null. When the method has no
	 * parameter, an empty array is passed in.
	 */
	@CheckForNull
	protected abstract Object handleInvocation(Object proxy, Method method, @Nullable Object[] args) throws Throwable;

	/**
	 * By default delegates to {@link Object#equals} so instances are only equal if they
	 * are identical. {@code proxy.equals(argument)} returns true if:
	 *
	 * <ul>
	 * <li>{@code proxy} and {@code argument} are of the same type
