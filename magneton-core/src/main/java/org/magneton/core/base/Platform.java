...
final class Platform {
	...
	static org.magneton.core.base.CharMatcher precomputeCharMatcher(CharMatcher matcher) {
		return matcher.precomputedInternal();
	}

	static <T extends Enum<T>> org.magneton.core.base.Optional<T> getEnumIfPresent(Class<T> enumClass, String value) {
		WeakReference<? extends Enum<?>> ref = Enums.getEnumConstants(enumClass).get(value);
		return ref == null ? org.magneton.core.base.Optional.<T>absent() : Optional.of(enumClass.cast(ref.get()));
	}
	...
	private static final class JdkPatternCompiler implements PatternCompiler {
		...
		public CommonPattern compile(String pattern) {
			return new org.magneton.core.base.JdkPattern(Pattern.compile(pattern));
		}
