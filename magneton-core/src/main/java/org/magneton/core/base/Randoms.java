 ...
 * <a href="https://commons.apache.org/rng">Commons RNG</a>, that may be a better choice
 * for applications with more stringent requirements (performance and/or correctness).
 * </p>
 *
 * @since 3.3
 */
public class Randoms {
	...
	/**
	 * <p>
	 * {@code RandomUtils} instances should NOT be constructed in standard programming.
	 * Instead, the class should be used as {@code RandomUtils.nextBytes(5);}.
	 * </p>
	 *
	 * <p>
