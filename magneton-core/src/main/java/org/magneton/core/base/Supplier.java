 ...
 * Semantically, this could be a factory, generator, builder, closure, or something else
 ...
 *
 * <p>
 * As this interface extends {@code java.util.function.Supplier}, an instance of this type
 * can be used as a {@code java.util.function.Supplier} directly. To use a {@code
...
public interface Supplier<T> extends java.util.function.Supplier<T> {
	...
	/**
	 * Retrieves an instance of the appropriate type. The returned object may or may not
	 * be a new instance, depending on the implementation.
