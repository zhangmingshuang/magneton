 ...
 * "https://github.com/google/guava/wiki/ConditionalFailuresExplained">verification
 * check</a>, including those performed by the convenience methods of the {@link Verify}
 * class.
 *
 * @since 17.0
 */
...
public class VerifyException extends RuntimeException {
	...
	/**
	 * Constructs a {@code VerifyException} with the cause {@code cause} and a message
	 * that is {@code
