...
/**
 * An immutable version of CharMatcher for smallish sets of characters that uses a hash
 * table with linear probing to check for matches.
 *
...
final class SmallCharMatcher extends NamedFastMatcher {
	...
	/*
	 * This method was rewritten in Java from an intermediate step of the Murmur hash
	 * function in http://code.google.com/p/smhasher/source/browse/trunk/MurmurHash3.cpp,
