...
/**
 * Phantom reference with a {@code finalizeReferent()} method which a background thread
 * invokes after the garbage collector reclaims the referent. This is a simpler
 * alternative to using a {@link ReferenceQueue}.
 *
 * <p>
