 ...
 *
 * <p>
 * A {@code CharEscaper} instance is required to be stateless, and safe when used
...
public abstract class CharEscaper extends Escaper {
	...
	/**
	 * Returns the escaped form of the given character, or {@code null} if this character
	 * does not need to be escaped. If an empty array is returned, this effectively strips
	 * the input character from the resulting text.
	 *
	 * <p>
	 * If the character does not need to be escaped, this method should return
	 * {@code null}, rather than a one-character array containing the character itself.
	 * This enables the escaping algorithm to perform more efficiently.
	 *
	 * <p>
	 * An escaper is expected to be able to deal with any {@code char} value, so this
