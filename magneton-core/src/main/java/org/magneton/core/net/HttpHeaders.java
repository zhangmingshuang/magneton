...
public final class HttpHeaders {
	...
	/**
	 * The HTTP
	 * <a href="https://fetch.spec.whatwg.org/#cross-origin-resource-policy-header">{@code
	...
	/**
	 * The HTTP <a href="https://tools.ietf.org/html/rfc8470">{@code Early-Data}</a>
	 * header field name.
	 *
	 * @since 27.0
	 */
	...
	/**
	 * The HTTP <a href="https://tools.ietf.org/html/rfc7239">{@code Forwarded}</a> header
	 * field name.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://tools.ietf.org/html/rfc7540#section-3.2.1">{@code HTTP2-Settings}
	 * </a> header field name.
	 *
	 * @since 24.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://github.com/WICG/origin-isolation">{@code Origin-Isolation}</a>
	 * header field name.
	 *
	 * @since 30.1
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://www.w3.org/TR/referrer-policy/">{@code Referrer-Policy}</a> header
	 * field name.
	 *
	 * @since 23.4
	 */
	...
	/**
	 * The HTTP <a href=
	 * "https://w3c.github.io/webappsec-upgrade-insecure-requests/#preference">{@code
	...
	/**
	 * The HTTP
	 * <a href="http://w3.org/TR/CSP/#content-security-policy-header-field">{@code
	...
	/**
	 * The HTTP
	 * <a href="http://w3.org/TR/CSP/#content-security-policy-report-only-header-field">
	...
	/**
	 * The HTTP nonstandard {@code X-Content-Security-Policy} header field name. It was
	 * introduced in <a href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP v.1</a> and
	 * used by the Firefox until version 23 and the Internet Explorer version 10. Please,
	...
	/**
	 * The HTTP nonstandard {@code X-Content-Security-Policy-Report-Only} header field
	 * name. It was introduced in
	 * <a href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP v.1</a> and used by the
	 * Firefox until version 23 and the Internet Explorer version 10. Please, use
	 * {@link #CONTENT_SECURITY_POLICY_REPORT_ONLY} to pass the CSP.
	 *
	 * @since 20.0
	 */
	 ...
	 * <a href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP v.1</a> and used by the
	 * Chrome until version 25. Please, use {@link #CONTENT_SECURITY_POLICY} to pass the
	 * CSP.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * The HTTP nonstandard {@code X-WebKit-CSP-Report-Only} header field name. It was
	 * introduced in <a href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP v.1</a> and
	 * used by the Chrome until version 25. Please, use
	 * {@link #CONTENT_SECURITY_POLICY_REPORT_ONLY} to pass the CSP.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://wicg.github.io/cross-origin-embedder-policy/#COEP-RO">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://googlechrome.github.io/OriginTrials/#header">{@code Origin-Trial}</a>
	 * header field name.
	 *
	 * @since 27.1
	 */
	...
	/**
	 * The HTTP {@code Refresh} header field name. Non-standard header supported by most
	 * browsers.
	 */
	public static final String REFRESH = "Refresh";

	/**
	 * The HTTP <a href="https://www.w3.org/TR/reporting/">{@code Report-To}</a> header
	 * field name.
	 *
	 * @since 27.1
	 */
	...
	/**
	 * The HTTP <a href="https://www.w3.org/TR/server-timing/">{@code Server-Timing}</a>
	 * header field name.
	 *
	 * @since 23.6
	 */
	...
	/**
	 * The HTTP
	 * <a href="http://www.w3.org/TR/resource-timing/#cross-origin-resources">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://iabtechlab.com/wp-content/uploads/2019/06/VAST_4.2_final_june26.pdf">{@code
	 * X-Device-IP}</a> header field name. Header used for VAST requests to provide the IP
	 * address of the device on whose behalf the request is being made.
	 *
	 * @since 31.0
	 */
	 ...
	 * The HTTP <a href=
	 * "https://iabtechlab.com/wp-content/uploads/2019/06/VAST_4.2_final_june26.pdf">{@code
	 * X-Device-Referer}</a> header field name. Header used for VAST requests to provide
	 * the {@link #REFERER} header value that the on-behalf-of client would have used when
	 * making a request itself.
	 *
	 * @since 31.0
	 */
	 ...
	 * The HTTP <a href=
	 * "https://iabtechlab.com/wp-content/uploads/2019/06/VAST_4.2_final_june26.pdf">{@code
	 * X-Device-Accept-Language}</a> header field name. Header used for VAST requests to
	 * provide the {@link #ACCEPT_LANGUAGE} header value that the on-behalf-of client
	 ...
	 * The HTTP <a href=
	 * "https://iabtechlab.com/wp-content/uploads/2019/06/VAST_4.2_final_june26.pdf">{@code
	 * X-Device-Requested-With}</a> header field name. Header used for VAST requests to
	 * provide the {@link #X_REQUESTED_WITH} header value that the on-behalf-of client
	 * would have used when making a request itself.
	 *
	 * @since 31.0
	 */
	...
	/**
	 * The HTTP {@code X-Forwarded-For} header field name (superseded by
	 * {@code Forwarded}).
	 */
	...
	/**
	 * The HTTP <a href="http://goo.gl/lQirAH">{@code X-Forwarded-Host}</a> header field
	 * name.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * The HTTP <a href="http://goo.gl/YtV2at">{@code X-Forwarded-Port}</a> header field
	 * name.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * The HTTP <a href="https://goo.gl/VKpXxa">{@code X-Download-Options}</a> header
	 * field name.
	 *
	 * <p>
	 * When the new X-Download-Options header is present with the value {@code noopen},
	 * the user is prevented from opening a file download directly; instead, they must
	...
	/**
	 * The HTTP <a href=
	 * "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-DNS-Prefetch-Control">{@code
	 * X-DNS-Prefetch-Control}</a> header controls DNS prefetch behavior. Value can be
	 * "on" or "off". By default, DNS prefetching is "on" for HTTP pages and "off" for
	 * HTTPS pages.
	 */
	...
	/**
	 * The HTTP
	 * <a href="http://html.spec.whatwg.org/multipage/semantics.html#hyperlink-auditing">
	...
	/**
	 * The HTTP <a href=
	 * "https://developer.mozilla.org/en-US/docs/Web/HTTP/Link_prefetching_FAQ#As_a_server_admin.2C_can_I_distinguish_prefetch_requests_from_normal_requests.3F">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Device-Memory">{@code
	...
	/**
	 * The HTTP
	 * <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Downlink">{@code
	...
	/**
	 * The HTTP
	 * <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/ECT">{@code
	...
	/**
	 * The HTTP
	 * <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/RTT">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Save-Data">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Viewport-Width">{@code
	...
	/**
	 * The HTTP
	 * <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Width">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://www.w3.org/TR/permissions-policy-1/">{@code Permissions-Policy}</a> header
	 * field name.
	 *
	 * @since 31.0
	 */
	...
	/**
	 * The HTTP <a href=
	 * "https://wicg.github.io/user-preference-media-features-headers/#sec-ch-prefers-color-scheme">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://www.rfc-editor.org/rfc/rfc8942#name-the-accept-ch-response-head">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://datatracker.ietf.org/doc/html/draft-davidben-http-client-hint-reliability-03.txt#section-3">{@code
	...
	/**
	 * The HTTP
	 * <a href="https://wicg.github.io/ua-client-hints/#sec-ch-ua">{@code Sec-CH-UA}</a>
	 * header field name.
	 *
	 * @since 30.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://wicg.github.io/ua-client-hints/#sec-ch-ua-platform">{@code
	...
	/**
	 * The HTTP
	 * <a href="https://wicg.github.io/ua-client-hints/#sec-ch-ua-platform-version">{@code
	...
	/**
	 * The HTTP
	 * <a href="https://wicg.github.io/ua-client-hints/#sec-ch-ua-full-version">{@code
	...
	/**
	 * The HTTP <a href=
	 * "https://w3c.github.io/webappsec-fetch-metadata/">{@code Sec-Fetch-Dest}</a> header
	 * field name.
	 *
	 * @since 27.1
	 */
	...
	/**
	 * The HTTP <a href=
	 * "https://w3c.github.io/webappsec-fetch-metadata/">{@code Sec-Fetch-Mode}</a> header
	 * field name.
	 *
	 * @since 27.1
	 */
	...
	/**
	 * The HTTP <a href=
	 * "https://w3c.github.io/webappsec-fetch-metadata/">{@code Sec-Fetch-Site}</a> header
	 * field name.
	 *
	 * @since 27.1
	 */
	...
	/**
	 * The HTTP <a href=
	 * "https://w3c.github.io/webappsec-fetch-metadata/">{@code Sec-Fetch-User}</a> header
	 * field name.
	 *
	 * @since 27.1
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://w3c.github.io/webappsec-fetch-metadata/">{@code Sec-Metadata}</a>
	 * header field name.
	 *
	 * @since 26.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://tools.ietf.org/html/rfc6455">{@code Sec-WebSocket-Accept}</a>
	 * header field name.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://tools.ietf.org/html/rfc6455">{@code Sec-WebSocket-Extensions}</a>
	 * header field name.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://tools.ietf.org/html/rfc6455">{@code Sec-WebSocket-Key}</a> header
	 * field name.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://tools.ietf.org/html/rfc6455">{@code Sec-WebSocket-Protocol}</a>
	 * header field name.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * The HTTP
	 * <a href="https://tools.ietf.org/html/rfc6455">{@code Sec-WebSocket-Version}</a>
	 * header field name.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * The HTTP <a href="https://tools.ietf.org/html/rfc8586">{@code CDN-Loop}</a> header
	 * field name.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * Values for the
	 * <a href="https://www.w3.org/TR/referrer-policy/">{@code Referrer-Policy}</a>
	 * header.
	 *
	 * @since 23.4
	 */
