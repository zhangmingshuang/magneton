...
import org.magneton.core.collect.ImmutableListMultimap;
import org.magneton.core.collect.ImmutableMultiset;
...
/**
 * Represents an <a href="http://en.wikipedia.org/wiki/Internet_media_type">Internet Media
 * Type</a> (also known as a MIME Type or Content Type). This class also supports the
 * concept of media ranges
 * <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.1">defined by
 * HTTP/1.1</a>. As such, the {@code *} character is treated as a wildcard and is used to
 * represent any acceptable type or subtype value. A media type may not have wildcard type
 * with a declared subtype. The {@code *} character has no special meaning as part of a
 * parameter. All values for type, subtype, parameter attributes or parameter values must
 * be valid according to RFCs <a href="https://tools.ietf.org/html/rfc2045">2045</a> and
 * <a href="https://tools.ietf.org/html/rfc2046">2046</a>.
 *
 * <p>
 * All portions of the media type that are case-insensitive (type, subtype, parameter
 * attributes) are normalized to lowercase. The value of the {@code charset} parameter is
 * normalized to lowercase, but all others are left as-is.
 *
 * <p>
 * Note that this specifically does <strong>not</strong> represent the value of the MIME
 * {@code
 * Content-Type} header and as such has no support for header-specific considerations such
 * as line folding and comments.
 *
 * <p>
 * For media types that take a charset the predefined constants default to UTF-8 and have
 * a "_UTF_8" suffix. To get a version without a character set, use
 * {@link #withoutParameters}.
 *
 * @since 12.0
 * @author Gregory Kick
 */
...
public final class MediaType {
	...
	private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap
			.of(CHARSET_ATTRIBUTE, org.magneton.core.base.Ascii.toLowerCase(Charsets.UTF_8.name()));

	/** Matcher for type, subtype and attributes. */
	private static final org.magneton.core.base.CharMatcher TOKEN_MATCHER = org.magneton.core.base.CharMatcher.ascii()
			.and(org.magneton.core.base.CharMatcher.javaIsoControl().negate())
			.and(org.magneton.core.base.CharMatcher.isNot(' '))
			.and(org.magneton.core.base.CharMatcher.noneOf("()<>@,;:\\\"/[]?="));

	private static final org.magneton.core.base.CharMatcher QUOTED_TEXT_MATCHER = org.magneton.core.base.CharMatcher
			.ascii().and(org.magneton.core.base.CharMatcher.noneOf("\"\\\r"));

	/*
	 * This matches the same characters as linear-white-space from RFC 822, but we make no
	 * effort to enforce any particular rules with regards to line folding as stated in
	 * the class docs.
	 */
	private static final org.magneton.core.base.CharMatcher LINEAR_WHITE_SPACE = org.magneton.core.base.CharMatcher
			.anyOf(" \t\r\n");
	...
	private static final Map<MediaType, MediaType> KNOWN_TYPES = org.magneton.core.collect.Maps.newHashMap();
	...
	/*
	 * The following constants are grouped by their type and ordered alphabetically by the
	 * constant name within that type. The constant name should be a sensible identifier
	 * that is closest to the "common name" of the media. This is often, but not
	 * necessarily the same as the subtype.
	 *
	 * Be sure to declare all constants with the type and subtype in all lowercase. For
	 * types that take a charset (e.g. all text/* types), default to UTF-8 and suffix the
	 * constant name with "_UTF_8".
	 */
	 ...
	 * {@link #JAVASCRIPT_UTF_8 application/javascript} to be the correct media type for
	 * JavaScript, but this may be necessary in certain situations for compatibility.
	 */
	public static final MediaType TEXT_JAVASCRIPT_UTF_8 = createConstantUtf8(TEXT_TYPE, "javascript");

	/**
	 * <a href="http://www.iana.org/assignments/media-types/text/tab-separated-values">Tab
	 * separated values</a>.
	 *
	 * @since 15.0
	 */
	...
	/**
	 * UTF-8 encoded
	 * <a href="https://en.wikipedia.org/wiki/Wireless_Markup_Language">Wireless Markup
	 * Language</a>.
	 *
	 * @since 13.0
	 */
	...
	/**
	 * As described in <a href="http://www.ietf.org/rfc/rfc3023.txt">RFC 3023</a>, this
	 * constant ({@code text/xml}) is used for XML documents that are "readable by casual
	 * users." {@link #APPLICATION_XML_UTF_8} is provided for documents that are intended
	 * for applications.
	 */
	public static final MediaType XML_UTF_8 = createConstantUtf8(TEXT_TYPE, "xml");

	/**
	 * As described in <a href="https://w3c.github.io/webvtt/#iana-text-vtt">the VTT
	 * spec</a>, this is used for Web Video Text Tracks (WebVTT) files, used with the
	 * HTML5 track element.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * <a href="https://en.wikipedia.org/wiki/BMP_file_format">Bitmap file format</a>
	 * ({@code bmp} files).
	 *
	 * @since 13.0
	 */
	...
	/**
	 * The <a href="https://en.wikipedia.org/wiki/Camera_Image_File_Format">Canon Image
	 * File Format</a> ({@code crw} files), a widely-used "raw image" format for cameras.
	 * It is found in {@code /etc/mime.types}, e.g. in <a href=
	...
	/**
	 * The Photoshop File Format ({@code psd} files) as defined by <a href=
	 * "http://www.iana.org/assignments/media-types/image/vnd.adobe.photoshop">IANA</a>,
	 * and found in {@code /etc/mime.types}, e.g. <a href=
	 * "http://svn.apache.org/repos/asf/httpd/httpd/branches/1.3.x/conf/mime.types"></a>
	 * of the Apache <a href="http://httpd.apache.org/">HTTPD project</a>; for the
	 ...
	 * <a href="http://en.wikipedia.org/wiki/Adobe_Photoshop#File_format">Wikipedia</a>;
	 * this is the regular output/input of Photoshop (which can also export to various
	 * image formats; note that files with extension "PSB" are in a distinct but related
	 * format).
	 *
	 * <p>
	...
	/**
	 * <a href="https://www.iana.org/assignments/media-types/image/heif">HEIF image
	 * format</a>.
	 *
	 * @since 28.1
	 */
	...
	/**
	 * L16 audio, as defined by <a href="https://tools.ietf.org/html/rfc2586">RFC
	 * 2586</a>.
	 *
	 * @since 24.1
	 */
	...
	/**
	 * L24 audio, as defined by <a href="https://tools.ietf.org/html/rfc3190">RFC
	 * 3190</a>.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * Advanced Audio Coding. For more information, see
	 * <a href="https://en.wikipedia.org/wiki/Advanced_Audio_Coding">Advanced Audio
	 * Coding</a>.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * Vorbis Audio, as defined by <a href="http://tools.ietf.org/html/rfc5215">RFC
	 * 5215</a>.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * Windows Media Audio. For more information, see <a href=
	 * "https://msdn.microsoft.com/en-us/library/windows/desktop/dd562994(v=vs.85).aspx">file
	...
	/**
	 * Windows Media metafiles. For more information, see <a href=
	 * "https://msdn.microsoft.com/en-us/library/windows/desktop/dd562994(v=vs.85).aspx">file
	 * name extensions for Windows Media metafiles</a>.
	 *
	 * @since 20.0
	...
	/**
	 * Real Audio. For more information, see
	...
	/**
	 * WAVE format, as defined by <a href="https://tools.ietf.org/html/rfc2361">RFC
	 * 2361</a>.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * The 3GP multimedia container format. For more information, see <a href=
	 * "ftp://www.3gpp.org/tsg_sa/TSG_SA/TSGS_23/Docs/PDF/SP-040065.pdf#page=10">3GPP TS
	 * 26.244</a>.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * The 3G2 multimedia container format. For more information, see <a href=
	 * "http://www.3gpp2.org/Public_html/specs/C.S0050-B_v1.0_070521.pdf#page=16">3GPP2
	 * C.S0050-B</a>.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * As described in <a href="http://www.ietf.org/rfc/rfc3023.txt">RFC 3023</a>, this
	 * constant ({@code application/xml}) is used for XML documents that are "unreadable
	 * by casual users." {@link #XML_UTF_8} is provided for documents that may be read by
	 * users.
	 *
	 * @since 14.0
	 */
	...
	/**
	 * Files in the
	 * <a href="https://www.dartlang.org/articles/embedding-in-html/">dart</a> programming
	 * language.
	 *
	 * @since 19.0
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Embedded_OpenType">Embedded OpenType</a>
	 * fonts. This is <a href=
	 * "http://www.iana.org/assignments/media-types/application/vnd.ms-fontobject">registered
	 * </a> with the IANA.
	 *
	 * @since 17.0
	 */
	...
	/**
	 * As described in the <a href="http://idpf.org/epub">International Digital Publishing
	 * Forum</a> EPUB is the distribution and interchange format standard for digital
	 * publications and documents. This media type is defined in the
	 * <a href="http://www.idpf.org/epub/30/spec/epub30-ocf.html">EPUB Open Container
	...
	/**
	 * As described in <a href="https://www.rsa.com/rsalabs/node.asp?id=2138">PKCS #12:
	 * Personal Information Exchange Syntax Standard</a>, PKCS #12 defines an archive file
	 * format for storing many cryptography objects as a single file.
	 *
	 * @since 15.0
	 */
	 ...
	 * files as it is <a href=
	 * "http://code.google.com/p/browsersec/wiki/Part2#Survey_of_content_sniffing_behaviors">
	 * known not to trigger content sniffing in current browsers</a>. It <i>should not</i>
	 * be used in other situations as it is not specified by any RFC and does not appear
	 * in the <a href="http://www.iana.org/assignments/media-types">/IANA MIME Media
	 * Types</a> list. Consider {@link #OCTET_STREAM} for binary data that is not being
	 * served to a browser.
	 *
	 * @since 14.0
	 */
	...
	/**
	 * Media type for the <a href="https://tools.ietf.org/html/rfc7946">GeoJSON
	 * Format</a>, a geospatial data interchange format based on JSON.
	 *
	 * @since 28.0
	 */
	...
	/**
	 * <a href="https://tools.ietf.org/html/draft-kelly-json-hal-08#section-3">JSON
	...
	/**
	 * <a href="http://www.rfc-editor.org/rfc/rfc4329.txt">RFC 4329</a> declares this to
	 * be the correct media type for JavaScript, but {@link #TEXT_JAVASCRIPT_UTF_8
	 * text/javascript} may be necessary in certain situations for compatibility.
	 */
	public static final MediaType JAVASCRIPT_UTF_8 = createConstantUtf8(APPLICATION_TYPE, "javascript");

	/**
	 * For <a href="https://tools.ietf.org/html/rfc7515">JWS or JWE objects using the
	...
	/**
	 * <a href="http://www.opengeospatial.org/standards/kml/">OGC KML (Keyhole Markup
	 * Language)</a>.
	 */
	...
	/**
	 * <a href="http://goo.gl/1pGBFm">Apple over-the-air mobile configuration
	 * profiles</a>.
	 *
	 * @since 18.0
	 */
	...
	/**
	 * Media type for <a href=
	 * "https://en.wikipedia.org/wiki/Dynamic_Adaptive_Streaming_over_HTTP">Dynamic
	 * Adaptive Streaming over HTTP (DASH)</a>. This is <a href=
	 * "https://www.iana.org/assignments/media-types/application/dash+xml">registered</a>
	 * with the IANA.
	 *
	 * @since 28.2
	 */
	...
	/**
	 * WASM applications. For more information see <a href="https://webassembly.org/">the
	 * Web Assembly overview</a>.
	 *
	 * @since 27.0
	 */
	...
	/**
	 * NaCl applications. For more information see <a href=
	 * "https://developer.chrome.com/native-client/devguide/coding/application-structure">the
	...
	/**
	 * NaCl portable applications. For more information see <a href=
	 * "https://developer.chrome.com/native-client/devguide/coding/application-structure">the
	 * Developer Guide for Native Client Application Structure</a>.
	 *
	 * @since 20.0
	...
	/**
	 * <a href=
	 * "https://tools.ietf.org/id/draft-ellermann-opensearch-01.html">OpenSearch</a>
	 * Description files are XML files that describe how a website can be used as a search
	 * engine by consumers (e.g. web browsers).
	 *
	 * @since 28.2
	 */
	public static final MediaType OPENSEARCH_DESCRIPTION_UTF_8 = createConstantUtf8(APPLICATION_TYPE,
	...
	/**
	 * <a href="http://tools.ietf.org/html/draft-rfernando-protocol-buffers-00">Protocol
	 * buffers</a>
	 *
	 * @since 15.0
	 */
	...
	/**
	 * <a href="https://en.wikipedia.org/wiki/RDF/XML">RDF/XML</a> documents, which are
	 * XML serializations of
	 * <a href="https://en.wikipedia.org/wiki/Resource_Description_Framework">Resource
	 * Description Framework</a> graphs.
	 *
	 * @since 14.0
	 */
	...
	/**
	 * <a href="https://tools.ietf.org/html/rfc8081">RFC 8081</a> declares
	 * {@link #FONT_SFNT font/sfnt} to be the correct media type for SFNT, but this may be
	...
	/**
	 * {@code skp} files produced by the 3D Modeling software
	...
	/**
	 * As described in <a href="http://www.ietf.org/rfc/rfc3902.txt">RFC 3902</a>, this
	 * constant ({@code application/soap+xml}) is used to identify SOAP 1.2 message
	 * envelopes that have been serialized with XML 1.0.
	 *
	 * <p>
	 * For SOAP 1.1 messages, see {@code XML_UTF_8} per
	 * <a href="http://www.w3.org/TR/2000/NOTE-SOAP-20000508/">W3C Note on Simple Object
	 * Access Protocol (SOAP) 1.1</a>
	 *
	 * @since 20.0
	 */
	...
	/**
	 * <a href="https://tools.ietf.org/html/rfc8081">RFC 8081</a> declares
	 * {@link #FONT_WOFF font/woff} to be the correct media type for WOFF, but this may be
	 * necessary in certain situations for compatibility.
	 *
	 * @since 17.0
	 */
	...
	/**
	 * <a href="https://tools.ietf.org/html/rfc8081">RFC 8081</a> declares
	 * {@link #FONT_WOFF2 font/woff2} to be the correct media type for WOFF2, but this may
	 * be necessary in certain situations for compatibility.
	 *
	 * @since 20.0
	 */
	...
	/**
	 * Extensible Resource Descriptors. This is not yet registered with the IANA, but it
	 * is specified by OASIS in the
	 * <a href="http://docs.oasis-open.org/xri/xrd/v1.0/cd02/xrd-1.0-cd02.html">XRD
	 * definition</a> and implemented in projects such as
	...
	/**
	 * A collection of font outlines as defined by
	...
	/**
	 * <a href="https://en.wikipedia.org/wiki/OpenType">Open Type Font Format</a> (OTF) as
	 * defined by <a href="https://tools.ietf.org/html/rfc8081">RFC 8081</a>.
	 *
	 * @since 30.0
	 */
	...
	/**
	 * <a href="https://en.wikipedia.org/wiki/SFNT">Spline or Scalable Font Format</a>
	 * (SFNT). <a href="https://tools.ietf.org/html/rfc8081">RFC 8081</a> declares this to
	 * be the correct media type for SFNT, but {@link #SFNT application/font-sfnt} may be
	 * necessary in certain situations for compatibility.
	 *
	 * @since 30.0
	 */
	...
	/**
	 * <a href="https://en.wikipedia.org/wiki/TrueType">True Type Font Format</a> (TTF) as
	 * defined by <a href="https://tools.ietf.org/html/rfc8081">RFC 8081</a>.
	 *
	 * @since 30.0
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Web_Open_Font_Format">Web Open Font
	 * Format</a> (WOFF). <a href="https://tools.ietf.org/html/rfc8081">RFC 8081</a>
	 * declares this to be the correct media type for SFNT, but {@link #WOFF
	 * application/font-woff} may be necessary in certain situations for compatibility.
	 *
	 * @since 30.0
	 */
	...
	/**
	 * <a href="http://en.wikipedia.org/wiki/Web_Open_Font_Format">Web Open Font
	 * Format</a> (WOFF2). <a href="https://tools.ietf.org/html/rfc8081">RFC 8081</a>
	 * declares this to be the correct media type for SFNT, but {@link #WOFF2
	 * application/font-woff2} may be necessary in certain situations for compatibility.
	 *
	 * @since 30.0
	 */
	public static final MediaType FONT_WOFF2 = createConstant(FONT_TYPE, "woff2");

	private static final org.magneton.core.base.Joiner.MapJoiner PARAMETER_JOINER = org.magneton.core.base.Joiner
	...
	@LazyInit
	@CheckForNull
	private org.magneton.core.base.Optional<Charset> parsedCharset;
	...
	private static MediaType createConstant(String type, String subtype) {
		MediaType mediaType = addKnownType(new MediaType(type, subtype, ImmutableListMultimap.<String, String>of()));
		mediaType.parsedCharset = org.magneton.core.base.Optional.absent();
		return mediaType;
	}

	private static MediaType createConstantUtf8(String type, String subtype) {
		MediaType mediaType = addKnownType(new MediaType(type, subtype, UTF_8_CONSTANT_PARAMETERS));
		mediaType.parsedCharset = org.magneton.core.base.Optional.of(Charsets.UTF_8);
		return mediaType;
	}
	 ...
	 * @throws IllegalArgumentException if type or subtype is invalid or if a wildcard is
	 * used for the type, but not the subtype.
	 */
	...
	private static MediaType create(String type, String subtype,
			org.magneton.core.collect.Multimap<String, String> parameters) {
		Preconditions.checkNotNull(type);
		Preconditions.checkNotNull(subtype);
		Preconditions.checkNotNull(parameters);
		String normalizedType = normalizeToken(type);
		String normalizedSubtype = normalizeToken(subtype);
		Preconditions.checkArgument(!WILDCARD.equals(normalizedType) || WILDCARD.equals(normalizedSubtype),
	...
	private static String normalizeToken(String token) {
		...
		return org.magneton.core.base.Ascii.toLowerCase(token);
	}

	private static String normalizeParameterValue(String attribute, String value) {
		Preconditions.checkNotNull(value); // for GWT
		Preconditions.checkArgument(org.magneton.core.base.CharMatcher.ascii().matchesAllOf(value),
				"parameter values must be ASCII: %s", value);
			...
			while (tokenizer.hasMore()) {
				...
				if ('"' == tokenizer.previewChar()) {
					...
					while ('"' != tokenizer.previewChar()) {
						if ('\\' == tokenizer.previewChar()) {
							tokenizer.consumeCharacter('\\');
							valueBuilder.append(tokenizer.consumeCharacter(org.magneton.core.base.CharMatcher.ascii()));
						}
						else {
	...
	/**
	 * Returns the top-level media type. For example, {@code "text"} in
	 * {@code "text/plain"}.
	 */
	public String type() {
		return type;
	...
	/**
	 * Returns an optional charset for the value of the charset parameter if it is
	 * specified.
	 * @throws IllegalStateException if multiple charset values have been set for this
	 * media type
	 * @throws IllegalCharsetNameException if a charset value is present, but illegal
	 * @throws UnsupportedCharsetException if a charset value is present, but no support
	 * is available in this instance of the Java virtual machine
	 */
	public org.magneton.core.base.Optional<Charset> charset() {
		// racy single-check idiom, this is safe because Optional is immutable.
		org.magneton.core.base.Optional<Charset> local = parsedCharset;
		if (local == null) {
			String value = null;
			local = org.magneton.core.base.Optional.absent();
			for (String currentValue : parameters.get(CHARSET_ATTRIBUTE)) {
				if (value == null) {
					value = currentValue;
					local = org.magneton.core.base.Optional.of(Charset.forName(value));
				}
	...
	/**
	 * Returns a new instance with the same type and subtype as this instance, but without
	 * any parameters.
	 */
	 ...
	 */
	public MediaType withParameters(org.magneton.core.collect.Multimap<String, String> parameters) {
		return create(type, subtype, parameters);
	}

	/**
	 * <em>Replaces</em> all parameters with the given attribute with parameters using the
	 * given values. If there are no values, any existing parameters with the given
	 * attribute are removed.
	 * @throws IllegalArgumentException if either {@code attribute} or {@code values} is
	 * invalid
	 * @since 24.0
	 */
	public MediaType withParameters(String attribute, Iterable<String> values) {
		...
		// Return one of the constants if the media type is a known type.
		return org.magneton.core.base.MoreObjects.firstNonNull(KNOWN_TYPES.get(mediaType), mediaType);
	}

	/**
	 * <em>Replaces</em> all parameters with the given attribute with a single parameter
	 * with the given value. If multiple parameters with the same attributes are necessary
	 * use {@link #withParameters(String, Iterable)}. Prefer {@link #withCharset} for
	 * setting the {@code charset} parameter when using a {@link Charset} object.
	 * @throws IllegalArgumentException if either {@code attribute} or {@code value} is
	 * invalid
	 */
	 ...
	 * {@code
	 * charset} parameter set to the {@link Charset#name name} of the given charset. Only
	 * one {@code
	 * charset} parameter will be present on the new instance regardless of the number set
	 * on this one.
	 *
	 * <p>
	...
	public MediaType withCharset(Charset charset) {
		...
		withCharset.parsedCharset = org.magneton.core.base.Optional.of(charset);
		return withCharset;
	}
	 ...
	 * <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html">the HTTP Accept
	 * header</a>) given by the argument according to three criteria:
	 *
	 * <ol>
	 * <li>The type of the argument is the wildcard or equal to the type of this instance.
	 * <li>The subtype of the argument is the wildcard or equal to the subtype of this
	 * instance.
	 ...
	 *
	 * <p>
	 * Note that while it is possible to have the same parameter declared multiple times
	 * within a media type this method does not consider the number of occurrences of a
	 * parameter. For example, {@code "text/plain; charset=UTF-8"} satisfies
	...
	private String computeToString() {
		...
		if (!parameters.isEmpty()) {
			...
			Multimap<String, String> quotedParameters = Multimaps.transformValues(parameters,
					(String value) -> (TOKEN_MATCHER.matchesAllOf(value) && !value.isEmpty()) ? value
	...
	private static final class Tokenizer {
		...
		String consumeTokenIfPresent(org.magneton.core.base.CharMatcher matcher) {
		...
		String consumeToken(org.magneton.core.base.CharMatcher matcher) {
			int startPosition = position;
		...
		char consumeCharacter(org.magneton.core.base.CharMatcher matcher) {
			Preconditions.checkState(hasMore());
			char c = previewChar();
