package org.magneton.framework.redis.safedog;

import com.google.common.base.Preconditions;
import com.google.common.base.Verify;
import lombok.AllArgsConstructor;
import org.magneton.framework.core.safedog.access.AccessConfig;
import org.magneton.framework.core.safedog.access.AccessException;
import org.magneton.framework.core.safedog.access.SafeDogAccessor;
import org.magneton.framework.core.safedog.access.SafeDogAccessorProcessor;
 ...
 * @since 2023.9
 */
public class RedissonSafeDogAccessorProcessor implements SafeDogAccessorProcessor {
	...
	public RedissonSafeDogAccessorProcessor(RedissonClient redissonClient) {
		this(redissonClient, DEFAULT_KEY);
	}

	public RedissonSafeDogAccessorProcessor(RedissonClient redissonClient, String key) {
	...
	public SafeDogAccessor create(String name) {
		...
		return new RedissonSafeDogAccessor(name, this.accessConfig, this.redissonClient, this.key);
	}

	@AllArgsConstructor
	public static class RedissonSafeDogAccessor implements SafeDogAccessor {
